...
{
    public partial class SalesPaymentList : BasePage
    {
        ...
        private void LoadData()
        {
            ...
            // 아파트 및 아파트 상가 청구 대상 리스트
            // KN_USP_MNG_SELECT_BILLINGINFO_S00
            dsReturn = ReceiptMngBlo.SpreadMngSalesBillingList(CommValue.BOARD_VALUE_PAGESIZE, Int32.Parse(hfCurrentPage.Value), txtSearchNm.Text, strRentCd, txtSearchRoom.Text, Session["LangCd"].ToString());
