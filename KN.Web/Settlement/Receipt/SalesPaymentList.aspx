<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Template/MainFrame.Master" AutoEventWireup="true" CodeBehind="SalesPaymentList.aspx.cs" Inherits="KN.Web.Settlement.Receipt.SalesPaymentList" ValidateRequest="false"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContent" runat="server">
    ...
    function fnDetailView(strUserSeq)
    {
        ...
        window.open("/Common/Popup/PopupSettleDetail.aspx?Datum0=" + strUserSeq + "&Datum1=&Datum2=&Datum3=&Datum4=", "DetailVeiw", "status=no, resizable=no, width=1100, height=800, left=100,top=100, scrollbars=no, menubar=no, toolbar=no, location=no");
    ...
    function fnDetailViewJs(strTxt)
    {
        ...
        var strRoomNo = document.getElementById("<%=txtRoomNo.ClientID%>").value;
        ...
        if (trim(strData2.value) == "0001")
        {
            ...
            {
                window.open("/Common/RdPopup/RDPopupMngFeeDetail.aspx?Datum0=&Datum1=" + strRentCd + "&Datum2=" + strData1.value + "&Datum3=" + strData3.value + "&Datum4=" + strData4.value + "&Datum5=" + strRoomNo, "ManageFee", "status=no, resizable=no, width=740, height=700, left=100,top=100, scrollbars=no, menubar=no, toolbar=no, location=no");
            }
            ...
            else if (trim(strData1.value) == "0008")
            {
                window.open("/Common/RdPopup/RDPopupElectFeeDetail.aspx?Datum0=&Datum1=" + strRentCd + "&Datum2=" + strData1.value + "&Datum3=" + strData3.value + "&Datum4=" + strData4.value + "&Datum5=" + strRoomNo, "ElecticCharge", "status=no, resizable=no, width=740, height=700, left=100,top=100, scrollbars=no, menubar=no, toolbar=no, location=no");
            }
            else if (trim(strData1.value) == "0009")
            {
                window.open("/Common/RdPopup/RDPopupWaterFeeDetail.aspx?Datum0=&Datum1=" + strRentCd + "&Datum2=" + strData1.value + "&Datum3=" + strData3.value + "&Datum4=" + strData4.value + "&Datum5=" + strRoomNo, "WaterRate", "status=no, resizable=no, width=740, height=700, left=100,top=100, scrollbars=no, menubar=no, toolbar=no, location=no");
            }
        ...
        else if (trim(strData2.value) == "0002")
        {
            if (strRentCd == "9000")
            {
                if (strData1.value == "0001" || strData1.value == "0008" || strData1.value == "0009" || strData1.value == "0010")
                {
                    window.open("/Common/RdPopup/RDPopupCNReceiptList.aspx?Datum0=&Datum1=&Datum2=" + strData1.value + "&Datum3=" + strData3.value + "&Datum4=" + strData4.value, "PayedReciept", "status=no, resizable=no, width=740, height=700, left=100,top=100, scrollbars=no, menubar=no, toolbar=no, location=no");
                }
                else
                {
                    window.open("/Common/RdPopup/RDPopupKNReceiptList.aspx?Datum0=&Datum1=&Datum2=" + strData1.value + "&Datum3=" + strData3.value + "&Datum4=" + strData4.value, "PayedReciept", "status=no, resizable=no, width=740, height=700, left=100,top=100, scrollbars=no, menubar=no, toolbar=no, location=no");
                }
            }
            else
            {
        ...
        <ContentTemplate>
            <fieldset class="sh-field2 MrgB10">
                ...
                <ul class="sf2-ag MrgL10">
                    ...
                    <li><asp:Literal ID="Literal1" runat="server" Text="Room No"></asp:Literal></li>
                    <li><asp:TextBox ID="txtRoomNo" runat="server" Width="60px" MaxLength="8" CssClass="sh-input"></asp:TextBox></li>
                    <li>
            ...
            <fieldset class="sh-field2 MrgB10" style="display: none">
                <legend>검색</legend>
                <ul class="sf2-ag MrgL10">
    ...
    <asp:UpdatePanel ID="upPaymentList" runat="server" Visible="False">
        <Triggers>
            <asp:AsyncPostBackTrigger ControlID="lnkbtnSearch" EventName="Click" />
            <asp:AsyncPostBackTrigger ControlID="imgbtnPageMove" EventName="Click" />
        </Triggers>
