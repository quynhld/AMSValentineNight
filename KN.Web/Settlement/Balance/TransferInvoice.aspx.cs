...
{
    public partial class TransferInvoice : BasePage
    {
        ...
        protected void LoadData()
        {
            ...
            // KN_USP_SET_SELECT_APT_HOADONINFO_S05
            var dtReturn = ReceiptMngBlo.SelectInvoiceTowerForTransfer(hfRentCd.Value, txtRoomNo.Text, sPayDt, eDt,
        ...
        protected void lvPrintoutList_ItemDataBound(object sender, ListViewItemEventArgs e)
        {
            ...
            var txthfDescription = (TextBox)iTem.FindControl("txthfDescription");

            if (!string.IsNullOrEmpty(drView["Desciption"].ToString()))
            {
                txthfDescription.Text = TextLib.StringDecoder(drView["Desciption"].ToString());
            }
            ...
            if (string.IsNullOrEmpty(drView["KSys_CustCd"].ToString()))
            {
        ...
        protected void lnkbtnIssuing_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                for (var i = CommValue.NUMBER_VALUE_0; i < lvPrintoutList.Items.Count; i++)
                {
                    ...
                    var rentCode = ((TextBox)lvPrintoutList.Items[i].FindControl("txthfRentCd")).Text;
                    ...
                    var description = ((TextBox)lvPrintoutList.Items[i].FindControl("txthfDescription")).Text;
