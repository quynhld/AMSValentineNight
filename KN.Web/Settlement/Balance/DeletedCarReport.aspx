<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Template/MainFrame.Master"
    AutoEventWireup="true" CodeBehind="DeletedCarReport.aspx.cs" Inherits="KN.Web.Settlement.Balance.DeletedCarReport"
...
function fnMovePage(intPageNo) 
{
  ...
  function fnOccupantList(rentcd,period, periodE, carTy,roomNo,carNo,cardNo) {
            window.open("/Common/RdPopup/RDPopupDeletedCarReport.aspx?Datum0=" + rentcd + "&Datum1=" + period + "&Datum2=" + periodE + "&Datum3=" + carTy + "&Datum4=" + roomNo + "&Datum5=" + carNo + "&Datum6=" + cardNo, "RentalInformationReport", "status=no, resizable=yes, width=1020, height=820, left=100,top=100, scrollbars=no, menubar=no, toolbar=no, location=no", false);
...
//-->
    ...
    <asp:UpdatePanel ID="upSearch1" runat="server" UpdateMode="Conditional">
        ...
        <ContentTemplate>           
            ...
            <li>
                <asp:Literal ID="ltSearchRoom" runat="server" Text = "Room"></asp:Literal></li>
            <li>
            ...
            <li>
                <asp:TextBox ID="txtSearchCarNo" runat="server" Width="60px" MaxLength="20" CssClass="sh-input"
                    OnKeyPress="javascript:return fnCheckType();"></asp:TextBox></li>
            <li>
                <asp:Literal ID="ltSearchCardNo" runat="server" Text = "Card No"></asp:Literal></li>
            <li>
