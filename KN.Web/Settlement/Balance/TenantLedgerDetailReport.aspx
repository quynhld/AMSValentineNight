<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Template/MainFrame.Master" AutoEventWireup="true" CodeBehind="TenantLedgerDetailReport.aspx.cs" Inherits="KN.Web.Settlement.Balance.TenantLedgerDetailReport" ValidateRequest="false"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContent" runat="server">
    ...
    <!--        //
        ...
        function fnSelectCheckValidate(strText) {
              ...
              var strPEndt = document.getElementById("<%=txtSearchDtE.ClientID%>");
        ...
        function fnOccupantList(feeTy, feeTyDt, period, periodE, payDt, payDtE, roomNo, userNm, paidCd) {
            ...
            window.open("/Common/RdPopup/RDPopupTenantLedgerDetailReport.aspx?Datum0=" + feeTy + "&Datum1=" + feeTyDt + "&Datum2=" + period + "&Datum3=" + periodE + "&Datum4=" + payDt + "&Datum5=" + payDtE + "&Datum6=" + roomNo + "&Datum7=" + userNm + "&Datum8=" + paidCd + "&Datum9=" + strRoomNo, "Tenant", "status=no, resizable=yes, width=1020, height=800, left=100,top=100, scrollbars=no, menubar=no, toolbar=no, location=no", false);
        ...
        function LoadCalender() {
            datePicker();
            document.getElementById("<%=txtPeriod.ClientID%>").value = formatStringToDate(EndDt);
        }
        ...
        function formatStringToMonth(strdate) {
...
<fieldset class="sh-field5 MrgB10" >
    ...
    <ul class="sf5-ag MrgL30">
        ...
        <li><asp:TextBox ID="txtRoomNo" CssClass="grBg bgType2" MaxLength="10" Width="80px" 
                runat="server" Visible="True" ontextchanged="txtRoomNo_TextChanged" AutoPostBack = "true"></asp:TextBox></li>        

        <li><b><asp:Literal ID="Literal5" runat="server" Text="Fee :" Visible = "false"></asp:Literal></b></li>
        <li><asp:DropDownList ID="ddlItemCd" runat="server" Visible = "false"></asp:DropDownList></li>   
        <li><b><asp:Literal ID="ltComPanyNameTitle" runat="server" Text="Tenant Name :"></asp:Literal></b></li>
        <li><asp:TextBox ID="txtCompanyNm" CssClass="grBg bgType2" MaxLength="285" Width="360px" runat="server" AutoPostBack="true"></asp:TextBox></li>    
     ...
     <ul class="sf5-ag MrgL30">
        ...
        <li><b><asp:Literal ID="ltInsPaidCd" runat="server" Text="Payment :" Visible="false" ></asp:Literal></b></li>
        <li><asp:DropDownList ID="ddlPaidCd" runat="server" Visible="false" ></asp:DropDownList></li>   
         <li>
    ...
    <div class="Btwps FloatR">
        <div class="Btn-Type2-wp FloatL">
            <div class="Btn-Tp2-L">
                <div class="Btn-Tp2-R">
                    <div class="Btn-Tp2-M">
                        <span><asp:LinkButton ID="lnkExportExcel" runat="server" OnClick="lnkbtnExcelReport_Click" Text="Export Excel" Visible ="false"></asp:LinkButton></span>
                    </div>
                </div>
            </div>
        </div>
