...
{
    public partial class DeletedCarReport : BasePage
    {
        ...
        protected void lnkbtnSearch_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                var period = txtStartDt.Text.Trim().Replace("-", "");
                var periodE = txtEndDt.Text.Trim().Replace("-", "");
                var carTy = ddlCarTy.SelectedValue.ToString();
                var roomNo = txtSearchRoom.Text;
                var carNo = txtSearchCarNo.Text;
                var cardNo = txtSearchCardNo.Text;

                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "PreviewPrint", "fnOccupantList('" + rentcd + "','" + period + "','" + periodE + "','" + carTy + "','" + roomNo + "','" + carNo + "','" + cardNo + "');", CommValue.AUTH_VALUE_TRUE);
            }
            catch (Exception ex)
            {
                ErrLogger.MakeLogger(ex);
        ...
        protected void txtInsRoomNo_TextChanged(object sender, EventArgs e)
        {
