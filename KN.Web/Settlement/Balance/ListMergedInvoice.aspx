<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Template/MainFrame.Master" AutoEventWireup="true" CodeBehind="ListMergedInvoice.aspx.cs" Inherits="KN.Web.Settlement.Balance.ListMergedInvoice" ValidateRequest="false"%>
...
<fieldset class="sh-field5 MrgB10" >
    <legend>검색</legend>
     <ul class="sf5-ag MrgL30">        
        ...
        <li><b><asp:Literal ID="Literal1" runat="server" Text="Invoice No :"></asp:Literal></b></li>
        <li><asp:TextBox ID="txtInvoiceNo" CssClass="grBg bgType2" MaxLength="10" 
                Width="80px" runat="server" Visible="True" ></asp:TextBox></li>        
