<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Template/MainFrame.Master" AutoEventWireup="true" CodeBehind="AptRetailUtilityIndexReport.aspx.cs" Inherits="KN.Web.Settlement.Balance.AptRetailUtilityIndexReport" ValidateRequest="false"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContent" runat="server">
    ...
    <!--        //
        ...
        function fnAccountList(rentCd) {
            ...
            window.open("/Common/RdPopup/RDPopupEstateAptRetailUtilityIndexReport.aspx?Datum0=" + rentCd + "&Datum1=" + strStartDt , "AptRetailUtilityIndexReport", "status=no, resizable=no, width=1000, height=700, left=100,top=100, scrollbars=no, menubar=no, toolbar=no, location=no", false);
            return false;
        }
