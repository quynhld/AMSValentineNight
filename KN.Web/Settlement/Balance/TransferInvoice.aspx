<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Template/MainFrame.Master" AutoEventWireup="true" CodeBehind="TransferInvoice.aspx.cs" Inherits="KN.Web.Settlement.Balance.TransferInvoice" ValidateRequest="false"%>
...
<fieldset class="sh-field5 MrgB10" >
    ...
    <ul class="sf5-ag MrgL30">
        ...
        <li><asp:TextBox ID="txtCompanyNm" CssClass="grBg bgType2" MaxLength="30" Width="300px" runat="server"></asp:TextBox></li>        
    </ul>
                                ...
                                <asp:TextBox ID="txtHfInsNm" runat="server" Visible="false"></asp:TextBox>
                                 <asp:TextBox ID="txthfBillTy" runat="server" Visible="false"></asp:TextBox>
                                  <asp:TextBox ID="txthfFeeTyDt" runat="server" Visible="false"></asp:TextBox>
                                   ...
                                   <asp:TextBox ID="txthfDescription" runat="server" Visible="false"></asp:TextBox>
