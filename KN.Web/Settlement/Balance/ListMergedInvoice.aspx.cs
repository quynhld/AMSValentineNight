...
{
    public partial class ListMergedInvoice : BasePage
    {
        ...
        protected void lnkbtnIssuing_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                // KN_USP_MNG_SELECT_PAYMENTINFO_APT_MERGE_S00
                var dtSource = MngPaymentBlo.ListMergedInvoice(txtInvoiceNo.Text.Trim());
                ...
                var fileName = Server.UrlEncode("ListMergedInvoice - ").Replace("+", " ") + txtInvoiceNo.Text.Trim();
