<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Template/MainFrame.Master" AutoEventWireup="true" CodeBehind="TenantInformationOtherAmountReport.aspx.cs" Inherits="KN.Web.Settlement.Balance.TenantInformationOtherAmountReport" ValidateRequest="false"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContent" runat="server">
    ...
    <!--        //
        ...
        function fnAccountList(rentCd) {
            ...
            window.open("/Common/RdPopup/RDPopupEstateTenantInfoOtherAmountReport.aspx?Datum0=" + rentCd + "&Datum1=" + strStartDt + "&Datum2=" + strEndDt, "TenantsInformationOtherAmount", "status=no, resizable=no, width=1000, height=700, left=100,top=100, scrollbars=no, menubar=no, toolbar=no, location=no", false);
            return false;
        }
