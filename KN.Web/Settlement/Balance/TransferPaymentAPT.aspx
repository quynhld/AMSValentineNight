<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Template/MainFrame.Master" AutoEventWireup="true" CodeBehind="TransferPaymentAPT.aspx.cs" Inherits="KN.Web.Settlement.Balance.TransferPaymentAPT" ValidateRequest="false"%>
...
//            }
        ...
        function LoadCalender() {
            ...
            $('#<%=chkAll.ClientID %>').change(function () {
                var $this = $(this);
                var checkboxes = $('table#tblListPayment').find(':checkbox:not(:disabled)');
                if ($this.is(':checked')) {
...
<fieldset class="sh-field5 MrgB10" >
    ...
    <ul class="sf5-ag MrgL30">
        ...
        <li><asp:TextBox ID="txtCompanyNm" CssClass="grBg bgType2" MaxLength="100" Width="390px" runat="server"></asp:TextBox></li>        
    </ul>
    ...
    <div class="Btwps FloatR">
        ...
        <div class="Btn-Type2-wp FloatL">
            <div class="Btn-Tp2-L">
                <div class="Btn-Tp2-R">
                    <div class="Btn-Tp2-M">
                        <span><asp:LinkButton ID="lnkCancel" runat="server" OnClick="lnkCancel_Click" Text="Cancel Transfer"></asp:LinkButton></span>
                    </div>
                </div>
            </div>
        </div>
