<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Template/MainFrame.Master" AutoEventWireup="true" CodeBehind="InvoiceAptCancel.aspx.cs" Inherits="KN.Web.Settlement.Balance.InvoiceAptCancel" ValidateRequest="false"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContent" runat="server">
    ...
    <!--        //
        ...
        function fnOccupantList(refPrintNo) {        
            
            document.getElementById("<%=hfsendParam.ClientID%>").value = refPrintNo;

            window.open("/Common/RdPopup/RDPopupHoadonCNRePreview.aspx?Datum0=" + refPrintNo,"Reciept","status=no, resizable=no, width=740, height=800, left=100,top=100, scrollbars=no, menubar=no, toolbar=no, location=no",false);
...
<fieldset class="sh-field5 MrgB10" >
    <legend>검색</legend>
    <ul class="sf5-ag MrgL30" style="display: none">
            ...
            <table class="TbCel-Type6-A" cellpadding="0">
                <colgroup>
                    ...
                    <tr>
                        ...
                        <th>
                            <asp:Literal ID="ltPaymentTy" Text = "Invoice No" runat="server"></asp:Literal>
                        </th>
                        <th>
                        ...
                        <th class="Ls-line">
                            <asp:Literal ID="ltIssDate" runat="server"></asp:Literal>
                        </th>
                    </tr>
                </colgroup>
            </table>
                ...
                <asp:ListView ID="lvPrintoutList" runat="server" 
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td class="Bd-Lt TbTxtCenter">
                                <asp:TextBox ID="txtInsPayDate" runat="server" MaxLength="10" Width="70px" ReadOnly="true"></asp:TextBox>                                
                            </td>
                            <td class="Bd-Lt TbTxtCenter">
