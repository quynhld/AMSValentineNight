<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Template/MainFrame.Master" AutoEventWireup="true" CodeBehind="HoaDonPrintOutForAPTParking.aspx.cs" Inherits="KN.Web.Settlement.Balance.HoaDonPrintOutForAPTParking" ValidateRequest="false"%>
    ...
    <!--        //
        ...
        function fnCheckRoomNo(strAlertText, strTanVal, strLongVal, strShortVal) {
          ...
          function LoadPopupMerge(printNo) {  
               ...
               var strPrintDate = document.getElementById("<%=hfprintDate.ClientID%>").value;
        ...
        function fnOccupantList(refPrintNo,strBilCd, strPayDt) {        
            ...
            window.open("/Common/RdPopup/RDPopupHoaDonParkingAPTPreview.aspx?Datum0=" + refPrintNo + "&Datum1=" + strBilCd + "&Datum2=" + strPayDt,"Reciept","status=no, resizable=no, width=740, height=800, left=100,top=100, scrollbars=no, menubar=no, toolbar=no, location=no",false);
        ...
        function Func2(printSeq1) 
        {
            //alert(printSeq);
           <%=Page.GetPostBackEventReference(imgbtnDetailview1)%>;
        } 
...
<fieldset class="sh-field5 MrgB10" >
    ...
    <asp:UpdatePanel ID="upSettlement" runat="server" UpdateMode="Conditional">
        <Triggers>
            ...
            <asp:AsyncPostBackTrigger ControlID="imgbtnDetailview1" EventName="Click" />
            <asp:AsyncPostBackTrigger ControlID="lnkbtnMerge" EventName="Click" /> 
    ...
    <div class="Btwps FloatR2">
        <div class="Btn-Type3-wp ">
            <div class="Btn-Tp3-L">
                <div class="Btn-Tp3-R">
	                <div class="Btn-Tp3-M">
		                <span><asp:LinkButton ID="lnkbtnMerge" runat="server" 
                            OnClick="lnkbtnMerge_Click" Text="Merge Invoice"></asp:LinkButton></span>
	                </div>
                </div>
            </div>
        </div>
    ...
    <asp:HiddenField ID="hfprintDate" runat="server" />
     <asp:ImageButton ID="imgbtnDetailview" runat="server" ImageUrl="~/Common/Images/Common/blank.gif" onClick="imgbtnDetailview_Click"/>
      <asp:ImageButton ID="imgbtnDetailview1" runat="server" ImageUrl="~/Common/Images/Common/blank.gif" onClick="imgbtnDetailview1_Click"/>
</asp:Content>