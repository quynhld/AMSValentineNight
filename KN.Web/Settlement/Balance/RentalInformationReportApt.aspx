<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Template/MainFrame.Master" AutoEventWireup="true" CodeBehind="RentalInformationReportApt.aspx.cs" Inherits="KN.Web.Settlement.Balance.RentalInformationReportApt" ValidateRequest="false"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContent" runat="server">
    ...
    <!--        //
        ...
        function fnSelectCheckValidate(strText) {
            ...
            var txtPeriodE = document.getElementById("<%= txtPeriodE.ClientID %>");

            if (trim(txtPeriodE.value) == "") {
                txtPeriodE.focus();
                alert(strText);
                return false;
            }               
        ...
        function fnOccupantList(rentcd,period, periodE) {
            window.open("/Common/RdPopup/RDPopupRentalInfoAPT.aspx?Datum0=" + rentcd + "&Datum1=" + period + "&Datum2=" + periodE, "RentalInformationReport", "status=no, resizable=yes, width=1020, height=820, left=100,top=100, scrollbars=no, menubar=no, toolbar=no, location=no", false);
            
            return false;
        }

        function fnOccupantListCohabitant(rentcd, period, periodE) {
            window.open("/Common/RdPopup/RDPopupRentalCohabitantInfoAPT.aspx?Datum0=" + rentcd + "&Datum1=" + period + "&Datum2=" + periodE, "RentalInformationReport", "status=no, resizable=yes, width=1020, height=820, left=100,top=100, scrollbars=no, menubar=no, toolbar=no, location=no", false);
        ...
        <li>
	        <div class="Btn-Type4-wp">
		        <div class="Btn-Tp4-L">
			        <div class="Btn-Tp4-R">
				        <div class="Btn-Tp4-M">
					        <span><asp:LinkButton ID="lnkbtnSearch" runat="server"  Text="Search" 
                                onclick="lnkbtnSearch_Click"></asp:LinkButton></span>
				        </div>
			        </div>
		        </div>
	        </div>		        
