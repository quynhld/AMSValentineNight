<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Template/MainFrame.Master" AutoEventWireup="true" CodeBehind="ListOfIssuingDebitNoteReport.aspx.cs" Inherits="KN.Web.Settlement.Balance.ListOfIssuingDebitNoteReport" ValidateRequest="false"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContent" runat="server">
    ...
    <!--        //
        ...
        function fnAccountList(feeTy, rentCd, DeliDt) {
            ...
            window.open("/Common/RdPopup/RDPopupEstateListIssuingDebitNoteReport.aspx?Datum0=" + rentCd + "&Datum1=" + strRoomNo + "&Datum2=" + feeTy + "&Datum3=" + strStartDt + "&Datum4=" + strEndDt, "ListIssuingDebitNote", "status=no, resizable=no, width=1000, height=700, left=100,top=100, scrollbars=no, menubar=no, toolbar=no, location=no", false);
            return false;
        }
