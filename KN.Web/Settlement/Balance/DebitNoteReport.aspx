<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Template/MainFrame.Master" AutoEventWireup="true" CodeBehind="DebitNoteReport.aspx.cs" Inherits="KN.Web.Settlement.Balance.DebitNoteReport" ValidateRequest="false"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContent" runat="server">
    ...
    <!--        //
        ...
        function fnAccountList(feeTy, rentCd, DeliDt) {
            ...
            window.open("/Common/RdPopup/RDPopupEstateDebitNoteReport.aspx?Datum0=" + feeTy + "&Datum1=" + rentCd + "&Datum2=" + strStartDt + "&Datum3=" + strEndDt + "&Datum4=" + DeliDt, "IncomeParkingFeeList", "status=no, resizable=no, width=1000, height=700, left=100,top=100, scrollbars=no, menubar=no, toolbar=no, location=no", false);
            return false;
        }
