<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Template/MainFrame.Master" AutoEventWireup="true" CodeBehind="ReceiptPrintOutForAPT.aspx.cs" Inherits="KN.Web.Settlement.Balance.ReceiptPrintOutForAPT" ValidateRequest="false"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContent" runat="server">
    ...
    <!--        //
        ...
        function fnOccupantList(refPrintNo,strBilCd, strPayDt) {        
            ...
            window.open("/Common/RdPopup/RDPopupHoadonCNPreview.aspx?Datum0=" + refPrintNo + "&Datum1=" + strBilCd + "&Datum2=" + strPayDt,"Reciept","status=no, resizable=no, width=740, height=800, left=100,top=100, scrollbars=no, menubar=no, toolbar=no, location=no",false);
