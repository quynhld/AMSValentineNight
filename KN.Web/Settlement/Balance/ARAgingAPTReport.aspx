<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Template/MainFrame.Master" AutoEventWireup="true" CodeBehind="ARAgingAPTReport.aspx.cs" Inherits="KN.Web.Settlement.Balance.ARAgingAPTReport" ValidateRequest="false"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContent" runat="server">
    ...
    <!--        //
        ...
        function fnOccupantList(feeTy,startDt, endDt, roomNo) {
            window.open("/Common/RdPopup/RDPopupARAgingAPT.aspx?Datum0=" + feeTy + "&Datum1=" + startDt + "&Datum2=" + endDt + "&Datum3=" + roomNo, "ARAgingReport", "status=no, resizable=yes, width=1020, height=820, left=100,top=100, scrollbars=no, menubar=no, toolbar=no, location=no", false);
