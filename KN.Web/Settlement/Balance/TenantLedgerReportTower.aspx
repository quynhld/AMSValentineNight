<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Template/MainFrame.Master" AutoEventWireup="true" CodeBehind="TenantLedgerReportTower.aspx.cs" Inherits="KN.Web.Settlement.Balance.TenantLedgerReportTower" ValidateRequest="false"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContent" runat="server">
    ...
    <!--        //
        ...
        function fnOccupantList(feeTy, feeTyDt, period, periodE, payDt, payDtE, roomNo, userNm, paidCd, rentCd) {


            window.open("/Common/RdPopup/RDPopupTenantTrialOffice.aspx?Datum0=" + feeTy + "&Datum1=" + feeTyDt + "&Datum2=" + period + "&Datum3=" + periodE + "&Datum4=" + payDt + "&Datum5=" + payDtE + "&Datum6=" + roomNo + "&Datum7=" + userNm + "&Datum8=" + paidCd + "&Datum9=" + rentCd, "Tenant", "status=no, resizable=yes, width=1020, height=800, left=100,top=100, scrollbars=no, menubar=no, toolbar=no, location=no", false);
...
<fieldset class="sh-field5 MrgB10" >
    ...
    <ul class="sf5-ag MrgL30">
        ...
        <li><b><asp:Literal ID="Literal4" runat="server" Text="Issue Date :"></asp:Literal></b></li>
