<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Template/MainFrame.Master" AutoEventWireup="true" CodeBehind="UsingInvoiceReportAPT.aspx.cs" Inherits="KN.Web.Settlement.Balance.UsingInvoiceReportAPT" ValidateRequest="false"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContent" runat="server">
    ...
    <!--        //
        ...
        function fnOccupantList(period, serialNo) {


            window.open("/Common/RdPopup/RDPopupUsingInvoiceReportAPT.aspx?Datum0=" + period + "&Datum1=" + serialNo, "Tenant", "status=no, resizable=yes, width=1020, height=830, left=100,top=100, scrollbars=no, menubar=no, toolbar=no, location=no", false);
