<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Template/MainFrame.Master" AutoEventWireup="true" CodeBehind="ContractExpiredReport.aspx.cs" Inherits="KN.Web.Settlement.Balance.ContractExpiredReport" ValidateRequest="false"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContent" runat="server">
    ...
    <!--        //
        ...
        function fnOccupantList(rentcd,period, periodE) {
            window.open("/Common/RdPopup/RDPopupContractExpired.aspx?Datum0=" + rentcd + "&Datum1=" + period + "&Datum2=" + periodE, "RentalInformationReport", "status=no, resizable=yes, width=1020, height=820, left=100,top=100, scrollbars=no, menubar=no, toolbar=no, location=no", false);
