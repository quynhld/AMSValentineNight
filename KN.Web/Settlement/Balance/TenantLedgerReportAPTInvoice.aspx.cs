...
{
    public partial class TenantLedgerReportAPTInvoice : BasePage
    {
        ...
        {      
            ...
            try
            {
                ...
                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "PreviewPrint", "fnOccupantList('" + feeTy + "','" + feeTyDt + "','" + period + "','" + periodE + "','" + paydt + "','" + paydtE + "','" + roomNo + "','" + userNm + "','" + paidCd + "','" + invoiceNo + "');", CommValue.AUTH_VALUE_TRUE);
            }
            catch (Exception ex)
            {
                ErrLogger.MakeLogger(ex);
