<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Template/MainFrame.Master" AutoEventWireup="true" CodeBehind="RevenueByTransactionReportAPT.aspx.cs" Inherits="KN.Web.Settlement.Balance.RevenueByTransactionReportAPT" ValidateRequest="false"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContent" runat="server">
    ...
    <!--        //
        ...
        function fnOccupantList(period) {


            window.open("/Common/RdPopup/RDPopupRevenueByTransactionReportAPT.aspx?Datum0=" + period, "PaymentByTransactionCode", "status=no, resizable=yes, width=1020, height=830, left=100,top=100, scrollbars=no, menubar=no, toolbar=no, location=no", false);
