...
{
    public partial class ContractExpiredReport : BasePage
    {
        ...
        protected void lnkbtnExcelReport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var strEndDt = txtPeriodE.Text.Trim().Replace("-", "");
                var strRentCd = ddlInsRentCd.SelectedValue;

                var dtReturn = BalanceMngBlo.SelectExcelContractExpired(strRentCd, strStartDt, strEndDt);
