<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Template/MainFrame.Master" AutoEventWireup="true" CodeBehind="ReceivableFromTenantReportAPT.aspx.cs" Inherits="KN.Web.Settlement.Balance.ReceivableFromTenantReportAPT" ValidateRequest="false"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContent" runat="server">
    ...
    <!--        //
        ...
        function fnOccupantList(period,feeTy,feeTyDt) {


            window.open("/Common/RdPopup/RDPopupReceivableFromTenantAPT.aspx?Datum0=" + period + "&Datum1=" + feeTy + "&Datum2=" + feeTyDt, "Tenant", "status=no, resizable=yes, width=1020, height=830, left=100,top=100, scrollbars=no, menubar=no, toolbar=no, location=no", false);
