...
{
    public partial class HoaDonPrintOutForSpecialAPTParking : BasePage
    {
        ...
        protected void LoadData()
        {
            ...
            // KN_USP_SET_SELECT_APT_PKFEE_S01
            var dtReturn = ReceiptMngBlo.SelectSpecialHoadonAptPKF(hfRentCd.Value, txtRoomNo.Text, sPayDt,
                                                                        ddlItemCd.SelectedValue, ddlInvoiceYN.SelectedValue.ToString(), Session["LANGCD"].ToString(), txtCompanyNm.Text, txtInvoice.Text);
        ...
        protected void lvPrintoutList_ItemDataBound(object sender, ListViewItemEventArgs e)
        {
            ...
            if (e.Item.ItemType.Equals(ListViewItemType.DataItem))
            {
                ...
                var txtCmpNm  = (TextBox)iTem.FindControl("txtCmpNm");
                ...
                {
                    txtCmpNm.Text = drView["CmpNm"].ToString();
                }
        ...
        protected void lnkbtnIssuing_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (rbIsShow.SelectedValue == "N")
                {
                    ...
                    var strShowYN = rbIsShow.SelectedValue;

                    if (intCheckRow > CommValue.NUMBER_VALUE_0)
                    {
                        ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "PreviewPrint", "fnOccupantList('" + refPrintNo + "','" + billCd + "','" + paydt + "','" + strPrintDt + "','" + strShowYN + "');", CommValue.AUTH_VALUE_TRUE);
                    }
                    else
                    {
                        // 화면 초기화
                ...
                else
                {
                    ...
                    //var refSeq = ((TextBox)lvPrintoutList.Items[0].FindControl("txtHfRefSeq")).Text;

                    var refSeq = refPrintNo.ToString();
                    ...
                    InvoiceMngBlo.UpdatelHoadonReprintList("0000", refSeq, refPrintNo);
        ...
        {
            if(ddlInvoiceYN.SelectedValue.Equals("N"))
            {
                txtInvoice.Text = "";               
            }           
            LoadData();
