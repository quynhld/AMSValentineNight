<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Template/MainFrame.Master" AutoEventWireup="true" CodeBehind="AllocationRevenueReport.aspx.cs" Inherits="KN.Web.Settlement.Balance.AllocationRevenueReport" ValidateRequest="false"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContent" runat="server">
    ...
    <!--        //
        ...
        function fnAccountList(rentCd) {
            ...
            var strYear = document.getElementById("<%=ddlSearchYear.ClientID%>").value;
            ...
            var strFeeTy = document.getElementById("<%=ddlItemCd.ClientID%>").value;

            window.open("/Common/RdPopup/RDPopupKNAllocationRevenueReport.aspx?Datum0=" + rentCd + "&Datum1=" + strYear + "&Datum2=" + strRoomNo + "&Datum3=" + strStartDt + "&Datum4=" + strEndDt + "&Datum5=" + strFeeTy, "AllocationRevenue", "status=no, resizable=no, width=1000, height=700, left=100,top=100, scrollbars=no, menubar=no, toolbar=no, location=no", false);
            return false;
        }
