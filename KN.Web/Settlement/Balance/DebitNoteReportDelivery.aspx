<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Template/MainFrame.Master" AutoEventWireup="true" CodeBehind="DebitNoteReportDelivery.aspx.cs" Inherits="KN.Web.Settlement.Balance.DebitNoteReportDelivery" ValidateRequest="false"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContent" runat="server">
    ...
    <!--        //
        ...
        function fnAccountList(feeTy, rentCd, DeliDt) {
            ...
            window.open("/Common/RdPopup/RDPopupEstateDebitNoteDelivery.aspx?Datum0=" + feeTy + "&Datum1=" + rentCd + "&Datum2=" + strStartDt + "&Datum3=" + strEndDt + "&Datum4=" + DeliDt, "IncomeParkingFeeList", "status=no, resizable=no, width=1000, height=700, left=100,top=100, scrollbars=no, menubar=no, toolbar=no, location=no", false);
            return false;
        }
        ...
        function datePicker() {
            $("#<%=txtDelivery.ClientID %>").datepicker();
...
<fieldset class="sh-field5 MrgB10" >
    ...
    <ul class="sf5-ag MrgL30">
        ...
        <li><asp:DropDownList ID="ddlItemCd" runat="server"></asp:DropDownList></li> 
         ...
         <li><b><asp:Literal ID="Literal1" runat="server" Text="Delivery Date :"></asp:Literal></b></li>
        <li><asp:TextBox ID="txtDelivery" CssClass="grBg bgType2" MaxLength="10" Width="70px" runat="server"></asp:TextBox></li>
        <li><img align="absmiddle" alt="Calendar" onclick="CallCalendar('#<%=txtDelivery.ClientID %>')" src="/Common/Images/Common/calendar.gif" style="cursor: pointer;align: absmiddle;"  /></li>
          <li>
