<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Template/MainFrame.Master" AutoEventWireup="true" CodeBehind="TransferInvoiceAPT.aspx.cs" Inherits="KN.Web.Settlement.Balance.TransferInvoiceAPT" ValidateRequest="false"%>
...
//            }
        ...
        function LoadCalender() {
            ...
            $('#<%=chkAll.ClientID %>').change(function () {
                var $this = $(this);
                var checkboxes = $('table#tblListInvoice').find(':checkbox:not(:disabled)');
                if ($this.is(':checked')) {
...
<fieldset class="sh-field5 MrgB10" >
    ...
    <ul class="sf5-ag MrgL30">
        ...
        <li><b><asp:Literal ID="ltComPanyNameTitle" runat="server" Text="Slip No :"></asp:Literal></b></li>
        <li><asp:TextBox ID="txtCompanyNm" CssClass="grBg bgType2" MaxLength="40" Width="300px" runat="server"></asp:TextBox></li>        
    </ul>
        ...
        <ContentTemplate>
            <table class="TbCel-Type6-A" cellpadding="0">
                <colgroup>
                    ...
                    <tr>
                        ...
                        <th>
                            <asp:Literal ID="Literal8" runat="server" Text="Issue Date"></asp:Literal>
                        </th>
                        <th>
                            <asp:Literal ID="Literal4" runat="server" Text="InvoiceNo"></asp:Literal>
                        </th>
                        <th>
                        ...
                        <th>
                            <asp:Literal ID="ltAmount" runat="server" Text="Net"></asp:Literal>
                        </th>
                        <th>
                            <asp:Literal ID="Literal7" runat="server" Text="VAT"></asp:Literal>
                        </th>
                        <th>
            ...
            <div style="overflow-y: scroll; height: 410px; width: 840px;">
                <asp:ListView ID="lvPrintoutList" runat="server" 
                    ...
                    <LayoutTemplate>
                        <table cellpadding="0" class="TypeA-shorter" width="820" id="tblListInvoice">
                        <col width="2%" />
                        <col width="10%" />
                        <col width="10%" />
                        <col width="8%" />
                    ...
                    <ItemTemplate>
                        <tr>
                                ...
                                <asp:TextBox ID="txtHfInsNm" runat="server" Visible="false"></asp:TextBox>
                                 <asp:TextBox ID="txthfBillTy" runat="server" Visible="false"></asp:TextBox>
                                  <asp:TextBox ID="txthfFeeTyDt" runat="server" Visible="false"></asp:TextBox>
                                   <asp:TextBox ID="txthfDes" runat="server" Visible="false"></asp:TextBox>
                            ...
                            <td class="Bd-Lt TbTxtCenter">
                                <asp:Literal ID="ltNet" runat="server"></asp:Literal>
                            </td>
                            <td class="Bd-Lt TbTxtCenter">
                                <asp:Literal ID="ltVAT" runat="server"></asp:Literal>
                            </td>
                            <td class="Bd-Lt TbTxtCenter">
                    ...
                    <div class="Btn-Tp31-L">
                        <div class="Btn-Tp31-R">
                            <div class="Btn-Tp31-M">
                                <span>
                                    <asp:LinkButton ID="lnkbtnIssuing" runat="server" Text="Transfer" OnClick="lnkbtnIssuing_Click"></asp:LinkButton></span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="Btn-Type31-wp ">
                    <div class="Btn-Tp31-L">
                        <div class="Btn-Tp31-R">
                            <div class="Btn-Tp31-M">
                                <span>
                                    <asp:LinkButton ID="lnkbtnExcelReport" runat="server" OnClick="lnkbtnExcelReport_Click" Text="Export"></asp:LinkButton></span>
                            </div>
                        </div>
                    </div>
                </div>
