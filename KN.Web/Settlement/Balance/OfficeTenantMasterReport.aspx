<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Template/MainFrame.Master" AutoEventWireup="true" CodeBehind="OfficeTenantMasterReport.aspx.cs" Inherits="KN.Web.Settlement.Balance.OfficeTenantMasterReport" ValidateRequest="false"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContent" runat="server">
    ...
    <!--        //
        ...
        function fnAccountList(rentCd,langCd,indusCd,natCd) {
            // Datum0 : 시작일
            // Datum1 : 종료일
            ...
            window.open("/Common/RdPopup/RDPopupOfficeMasterListReport.aspx?Datum0=" + rentCd + "&Datum1=" + langCd + "&Datum2=" + indusCd + "&Datum3=" + natCd, "OfficeMasterListReport", "status=no, resizable=no, width=1000, height=700, left=100,top=100, scrollbars=no, menubar=no, toolbar=no, location=no", false);
...
<fieldset class="sh-field5 MrgB10" >
    ...
    <ul class="sf5-ag MrgL30">
         ...
         <li><b><asp:Literal ID="Literal5" runat="server" Text="Industry"></asp:Literal></b></li>
         <li>  <asp:DropDownList ID="ddlIndustry" runat="server"></asp:DropDownList></li> 
         <li><b><asp:Literal ID="Literal1" runat="server" Text="Nat"></asp:Literal></b></li>
         <li><asp:DropDownList ID="ddlNat" runat="server"></asp:DropDownList></li>           
