<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Template/MainFrame.Master" AutoEventWireup="true" CodeBehind="PrepaidRevenueReportAPT.aspx.cs" Inherits="KN.Web.Settlement.Balance.PrepaidRevenueReportAPT" ValidateRequest="false"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContent" runat="server">
    ...
    <!--        //
        ...
        function fnOccupantList(period, periodE,paidDt,paidDtE) {
            window.open("/Common/RdPopup/RDPopupPrepaidAPT.aspx?Datum0=" + period + "&Datum1=" + periodE + "&Datum2=" + paidDt + "&Datum3=" + paidDtE, "Tenant", "status=no, resizable=yes, width=1020, height=820, left=100,top=100, scrollbars=no, menubar=no, toolbar=no, location=no", false);
    ...
    <div class="Btwps FloatR">
        <div class="Btn-Type2-wp FloatL">
            <div class="Btn-Tp2-L">
                <div class="Btn-Tp2-R">
                    <div class="Btn-Tp2-M">
                        <span><asp:LinkButton ID="lnkExportExcel" runat="server" OnClick="lnkbtnExcelReport_Click" Text="Export VAT Excel"></asp:LinkButton></span>
                    </div>
                </div>
            </div>
        </div>
