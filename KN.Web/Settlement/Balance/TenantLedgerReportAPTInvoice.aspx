<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Template/MainFrame.Master" AutoEventWireup="true" CodeBehind="TenantLedgerReportAPTInvoice.aspx.cs" Inherits="KN.Web.Settlement.Balance.TenantLedgerReportAPTInvoice" ValidateRequest="false"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContent" runat="server">
    ...
    <!--        //
        ...
        function fnOccupantList(feeTy, feeTyDt, period, periodE, payDt, payDtE, roomNo, userNm, paidCd, invoiceNo) {


            window.open("/Common/RdPopup/RDPopupTenantTrialAPTInvoiceNo.aspx?Datum0=" + feeTy + "&Datum1=" + feeTyDt + "&Datum2=" + period + "&Datum3=" + periodE + "&Datum4=" + payDt + "&Datum5=" + payDtE + "&Datum6=" + roomNo + "&Datum7=" + userNm + "&Datum8=" + paidCd + "&Datum9=" + invoiceNo, "Tenant", "status=no, resizable=yes, width=1020, height=800, left=100,top=100, scrollbars=no, menubar=no, toolbar=no, location=no", false);
...
<fieldset class="sh-field5 MrgB10" >
    ...
    <ul class="sf5-ag MrgL30 bgimgN">
        ...
        <li><b><asp:Literal ID="Literal7" runat="server" Text="Invoice No :"></asp:Literal></b></li>
        <li><asp:TextBox ID="txtInvoiceNo" CssClass="grBg bgType2" MaxLength="10" Width="100px" runat="server" Visible="True"></asp:TextBox></li>         
