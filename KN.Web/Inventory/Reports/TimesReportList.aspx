<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Template/MainFrame.Master" AutoEventWireup="true" CodeBehind="TimesReportList.aspx.cs" Inherits="KN.Web.Inventory.TimesReportList" ValidateRequest="false"%>
