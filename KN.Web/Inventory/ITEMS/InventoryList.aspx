        ...
        <ContentTemplate>
            <fieldset class="sh-field2 MrgB10">
                ...
                <ul class="sf2-ag MrgL10">
                    <li><asp:Literal ID="ltSearchName" Text="Item Name" runat="server"></asp:Literal></li>
    ...
    <asp:UpdatePanel ID="upPaymentList" runat="server">
        ...
        <ContentTemplate>
            ...
            <asp:ListView ID="lvItemList" runat="server" ItemPlaceholderID="iphItemPlaceHolderID" >
                ...
                <ItemTemplate>
                    <tr>
                        <td class="TbTxtCenter"><asp:Literal ID="ltInsSeq" runat="server" Text='<% #Eval("IVN_ID")%>'></asp:Literal></td>
			            <td class="TbTxtCenter"><asp:Literal ID="ltIvtNm" runat="server"  Text='<% #Eval("Item_Name")%>'></asp:Literal></td>
			            <td class="TbTxtCenter"><asp:Literal ID="ltIvtLocation" runat="server"  Text='<% #Eval("Item_LC_Area")%>'></asp:Literal></td>
