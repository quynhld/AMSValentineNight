 ...
 */
 ...
 (function($){
	...
	$.fn.tablePagination = function(settings) {
		var defaults = {  
			firstArrow : (new Image()).src="/Common/Images/Grid/first.gif",
			prevArrow: (new Image()).src = "/Common/Images/Grid/prev.gif",
			lastArrow: (new Image()).src = "/Common/Images/Grid/last.gif",
			nextArrow: (new Image()).src = "/Common/Images/Grid/next.gif",
			rowsPerPage : 15,
			currPage : 1,
      ...
      function createPaginationElements() {
        ...
        htmlBuffer.push("<span id='tablePagination_perPage' style='display: none;'>");
