<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="IdFind.aspx.cs" Inherits="KN.Web.Common.Signup.IdFind" %>
			...
			<div class="Cont">
				...
				<div class="FIP-box">					
					<div class="FIalert2 MrgB10">
						<div class="Txwp"><p><asp:Literal ID="ltUserId" runat="server"></asp:Literal></p></div>
						<div class="FIP-btnw">
