<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="PwdNotFind.aspx.cs" Inherits="KN.Web.Common.Signup.PwdNotFind" %>
		    ...
		    <div class="Cont">
			    ...
			    <div class="FIP-box">    				
				    <div class="FIalert MrgB10">
					    <div class="Txwp"><p><asp:Literal ID="ltIdNotFound2" runat="server"></asp:Literal></p></div>
					    <div class="FIP-btnw">
