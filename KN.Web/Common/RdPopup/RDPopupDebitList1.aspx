<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RDPopupDebitList1.aspx.cs" Inherits="KN.Web.Common.RdPopup.RDPopupDebitList1" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
    <head id="Head1" runat="server">
        <title>Debit Preview</title>
    ...
    <body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style="height:800px; width:723px;">
        ...
        <script language="javascript" id="clientEventHandlersJS" type="text/javascript">
            ...
            Rdviewer.FileOpen('<%=NOW_DOMAIN%>/Common/Mrd/<%=strMRDFile%>', '/rv TempDocNo[<%=DOC_NO%>] ReqDt[<%=REQ_DT%>] PayType[<%=PAY_TYPE%>] ');
        </script>
        <asp:TextBox ID="txtHfDocNo" runat="server" Visible="false"></asp:TextBox>       
        <asp:TextBox ID="txtHfRentCd" runat="server" Visible="false"></asp:TextBox>   
        <asp:TextBox ID="txthfRequestDt" runat="server" Visible="false"></asp:TextBox>    
    </body>
</html>
