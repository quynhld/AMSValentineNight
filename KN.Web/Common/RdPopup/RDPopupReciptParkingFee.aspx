<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RDPopupReciptParkingFee.aspx.cs" Inherits="KN.Web.Common.RdPopup.RDPopupReciptParkingFee"%>
<html>
    <head>
        <title></title>
    </head>
    <body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style="height:700px; width:700px;">
        ...
        <script language="javascript" id="clientEventHandlersJS" type="text/javascript">
            ...
            Rdviewer.FileOpen('<%=NOW_DOMAIN%>/Common/Mrd/<%=strMRDFile%>', '/rv PSeq[<%=P_SEQ%>] Seq[<%=SEQ%>] paymentDt[<%=PAY_DT%>] UserNm[<%=Session["MemNm"].ToString()%>]');
