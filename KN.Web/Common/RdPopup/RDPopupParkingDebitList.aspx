<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RDPopupParkingDebitList.aspx.cs" Inherits="KN.Web.Common.RdPopup.RDPopupParkingDebitList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
    <head id="Head1" runat="server">
        <title>Debit Parking Preview</title>
    ...
    <body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style="height:600px; width:723px;">
        ...
        <script language="javascript" id="clientEventHandlersJS" type="text/javascript">
            ...
            Rdviewer.FileOpen('<%=NOW_DOMAIN%>/Common/Mrd/<%=strMRDFile %>', '/rv UserSeq[<%=USER_SEQ%>] Period[<%=PERIOD%>] RefSeq[<%=REF_SEQ%>]');  
        </script>
