...
{
    public partial class RDPopupHoadonCNConfirm: BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                    ...
                    strHostIp.Equals(CommValue.PUBLIC_VALUE_TESTDOMAIN.ToLower()))
                {
                    ...
                    strMRDFile = "Invoice_CNSThird_Reprint_L.mrd";
                }
        ...
        protected void imgbtnPrint_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                // KN_USP_SET_UPDATE_INVOICEFORTEMP_M04
                InvoiceMngBlo.UpdateInvoiceConfirmForAPT(txtHfDocNo.Text);
            }
            catch (Exception ex)
            {
