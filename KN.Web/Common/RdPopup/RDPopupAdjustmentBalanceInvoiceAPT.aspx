<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RDPopupAdjustmentBalanceInvoiceAPT.aspx.cs" Inherits="KN.Web.Common.RdPopup.RDPopupAdjustmentBalanceInvoiceAPT" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
    <head id="Head1" runat="server">
        <title>Adjusment Invoice APT</title>
        ...
        <script language="javascript" type="text/javascript">
            function ReLoadData(invoiceNo) {
                window.opener.fnLoadData(invoiceNo);
                this.close();
            }    
        </script>
        </head>
