<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RDPopupKeangnamHoadonList.aspx.cs" Inherits="KN.Web.Common.RdPopup.RDPopupKeangnamHoadonList" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
    <head id="Head1" runat="server">
        <title>Hoadon PrintOut</title>
        <link rel="stylesheet" type="text/css" href="/Common/Css/keangnam.css" />
    </head>
    <body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style="height:690px; width:730px;">
        <form id="form1" runat="server"> 
            <table class="TypeA-shorter">
                <tr>
                    <td width="1px"><asp:ImageButton ID="imgbtnPrintOut" runat= "server" ImageUrl="~/Common/Images/Common/nav-rpBg2.gif" onclick="imgbtnPrintOut_Click"/></td>
        ...
        <!--//
            function rd_Print()
            {
                var button = document.getElementById("<%=imgbtnPrintOut.ClientID%>"); //document.getElementByID("Image_Print");
                button.click();
        ...
        <script language="javascript" id="clientEventHandlersJS" type="text/javascript">
            ...
            Rdviewer.FileOpen('<%=NOW_DOMAIN%>/Common/Mrd/<%=strMRDFile%>', '/rv TempSerialNo[<%=HOADON_NO%>]');
        </script>
    </body>
</html>