...
{
    public partial class RDPopupHoaDonParkingSpecialAPTPreview : BasePage
    {
            ...
            else
            {
                if (Request.Params["Datum0"] != null)
                {
                    ...
                    if (!string.IsNullOrEmpty(Request.Params["Datum2"].ToString()))
                    {
                        ...
                        strDatum2 = strDatum2.Replace("-", "");
                    }
                    if (!string.IsNullOrEmpty(Request.Params["Datum3"].ToString()))
                    {
                    ...
                    strHostIp.Equals(CommValue.PUBLIC_VALUE_TESTDOMAIN.ToLower()))
                {
                    ...
                    strMRDFile = "Invoice_Special_ParkingFee_Preview_L_KNS.mrd";
