...
{
    public partial class RDPopupAdjustmentBalanceInvoiceAPT : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                    ...
                    strHostIp.Equals(CommValue.PUBLIC_VALUE_TESTDOMAIN.ToLower()))
                {
                    ...
                    strMRDFile = "Invoice_Adjustment_A0000_CNSThird_Preview_L.mrd";                    
                }
        ...
        protected void imgbtnPrint_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                sbNoSelection.Append("ReLoadData('" + reft + "');");
