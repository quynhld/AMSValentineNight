...
{
    public partial class RDPopupHoadonKNPreview2: BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                    ...
                    strHostIp.Equals(CommValue.PUBLIC_VALUE_TESTDOMAIN.ToLower()))
                {
                    ...
                    strMRDFile = "Invoice_KNSFourth2_Preview_L_P.mrd";
                }
        ...
        protected void imgbtnPrint_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                // KN_USP_SET_INSERT_INVOICEFORTEMP_S03
                InvoiceMngBlo.InsertTempHoadonForConfirmTower(txtHfDocNo.Text);
