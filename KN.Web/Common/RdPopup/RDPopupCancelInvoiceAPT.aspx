<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RDPopupCancelInvoiceAPT.aspx.cs" Inherits="KN.Web.Common.RdPopup.RDPopupCancelInvoiceAPT" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head id="Head1" runat="server">
        <title>Cancel Invoice APT</title>
    ...
    <body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style="height:800px; width:723px;">
        ...
        <script language="javascript" id="clientEventHandlersJS" type="text/javascript">
            ...
            Rdviewer.FileOpen('<%=NOW_DOMAIN%>/Common/Mrd/<%=strMRDFile%>', '/rv TempDocNo[<%=DOC_NO%>] Reson[<%=RESON %>] PrintNo[<%=PRINT_NO %>]');
        </script>
        <asp:TextBox ID="txthfInvoiceNo" runat="server" Visible="false"></asp:TextBox> 
        <asp:TextBox ID="txthfReason" runat="server" Visible="false"></asp:TextBox>   
