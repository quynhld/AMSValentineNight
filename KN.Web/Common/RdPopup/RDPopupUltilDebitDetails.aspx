<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RDPopupUltilDebitDetails.aspx.cs" Inherits="KN.Web.Common.RdPopup.RDPopupUltilDebitDetails" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
    <head id="Head1" runat="server">
        <title>Debit List Utility Printing</title>
    ...
    <body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style="height:768px; width:auto;">
        ...
        <script language="javascript" id="clientEventHandlersJS" type="text/javascript">
            ...
            Rdviewer.FileOpen('<%=NOW_DOMAIN%>/Common/Mrd/<%=strMRDFile%>', '/rv DateS[<%=DATE_S%>] RoomNo[0] RentCd[<%=RENT_CODE%>] ChargeTy[<%=CHARGE_TYPE%>] CompanyCd[<%=COMPANY_CODE %>] IsPrint[<%=IS_PRINT %>]');
        </script>
