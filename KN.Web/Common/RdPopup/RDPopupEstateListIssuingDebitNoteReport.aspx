<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RDPopupEstateListIssuingDebitNoteReport.aspx.cs" Inherits="KN.Web.Common.RdPopup.RDPopupEstateListIssuingDebitNoteReport" %>
...
<head id="Head1" runat="server">
 ...
 <body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style="height:700px; width:1000px;">
        ...
        <script language="javascript" id="clientEventHandlersJS" type="text/javascript">
            ...
            Rdviewer.FileOpen('<%=NOW_DOMAIN%>/Common/Mrd/<%=strMRDFile %>', '/rv RentCd[<%=strDatum0 %>] RoomNo[<%=strDatum1 %>] ItemCd[<%=strDatum2 %>] StartDt[<%=strDatum3 %>] EndDt[<%=strDatum4 %>] UserNm[<%=Session["MemNm"].ToString()%>]');
        </script>
    </body>
</html>