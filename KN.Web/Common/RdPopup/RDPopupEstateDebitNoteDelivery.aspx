<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RDPopupEstateDebitNoteDelivery.aspx.cs" Inherits="KN.Web.Common.RdPopup.RDPopupEstateDebitNoteDelivery" %>
...
<head id="Head1" runat="server">
 ...
 <body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style="height:700px; width:1000px;">
        ...
        <script language="javascript" id="clientEventHandlersJS" type="text/javascript">
            ...
            Rdviewer.FileOpen('<%=NOW_DOMAIN%>/Common/Mrd/<%=strMRDFile %>', '/rv FeeTy[<%=strDatum0 %>] RentCd[<%=strDatum1 %>] StartDt[<%=strDatum2 %>] EndDt[<%=strDatum3 %>] DeliDt[<%=strDatum4 %>] UserNm[<%=Session["MemNm"].ToString()%>]');
        </script>
    </body>
</html>