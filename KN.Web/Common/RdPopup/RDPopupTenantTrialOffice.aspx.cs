...
{
    public partial class RDPopupTenantTrialOffice : BasePage
    {
        ...
        private bool CheckParams()
        {
            ...
            {
                strDatum6 = Request.Params["Datum6"];
            }
            if (Request.Params["Datum7"] != null)
            {
                strDatum7 = Request.Params["Datum7"];
            }
            if (Request.Params["Datum8"] != null)
            {
                strDatum8 = Request.Params["Datum8"];
            }
            if (Request.Params["Datum9"] != null)
            {
                strDatum9 = Request.Params["Datum9"];
            }
                ...
                strHostIp.Equals(CommValue.PUBLIC_VALUE_TESTDOMAIN.ToLower()))
            {
                ...
                strMRDFile = "TenantLedgerTowerReport.mrd";           
            }
