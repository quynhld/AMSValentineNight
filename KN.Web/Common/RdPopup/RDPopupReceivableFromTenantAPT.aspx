<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RDPopupReceivableFromTenantAPT.aspx.cs" Inherits="KN.Web.Common.RdPopup.RDPopupReceivableFromTenantAPT" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Receivable From Tenant Report</title>
</head>
 <body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style="height:700px; width:1000px;">
        ...
        <script language="javascript" id="clientEventHandlersJS" type="text/javascript">
            ...
            Rdviewer.FileOpen('<%=NOW_DOMAIN%>/Common/Mrd/<%=strMRDFile %>', '/rv Period[<%=strDatum0 %>] FeeTy[<%=strDatum1 %>] FeeTyDt[<%=strDatum2 %>]');
        </script>
    </body>
</html>