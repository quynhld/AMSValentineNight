<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RDPopupAptParkingList.aspx.cs" Inherits="KN.Web.Common.RdPopup.RDPopupAptParkingList" %>
...
<head id="Head1" runat="server">
 ...
 <body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style="height:700px; width:1000px;">
        ...
        <script language="javascript" id="clientEventHandlersJS" type="text/javascript">
            ...
            Rdviewer.FileOpen('<%=NOW_DOMAIN%>/Common/Mrd/<%=strMRDFile %>', '/rv  RentCd[<%=strDatum0 %>] RoomNo[<%=strDatum1%>] CardNo[<%=strDatum2 %>] CarNo[<%=strDatum3 %>]  LangCd[<%=strDatum4 %>]');
        </script>
    </body>
</html>