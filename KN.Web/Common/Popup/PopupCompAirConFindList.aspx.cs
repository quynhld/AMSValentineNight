...
{
    public partial class PopupCompAirConFindList : BasePage
    {
        ...
        public const string PARAM_DATA6 = "SquareS";
        ...
        protected bool CheckParams()
        {
            ...
            if (Request.Params[PARAM_DATA1] != null)
            {
                if (!string.IsNullOrEmpty(Request.Params[PARAM_DATA1]) &&
                    !string.IsNullOrEmpty(Request.Params[PARAM_DATA2]))
                {
                    ...
                    HfReturnSquare.Value = Request.Params[PARAM_DATA6];
        ...
        protected void LoadData()
        {
            ...
            var dtReturn = RoomMngBlo.SelectRoomInfoOverTime(hfRentCd.Value, txtInsRoomNo.Text, txtCompNm.Text);
