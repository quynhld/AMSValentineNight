...
{
    public partial class RDPopupOccupantList : BasePage
    {
        ...
        private bool CheckParams()
        {
                ...
                strHostIp.Equals(CommValue.PUBLIC_VALUE_TESTDOMAIN.ToLower()))
            {
               ...
               // NOW_DOMAIN = CommValue.PUBLIC_VALUE_TESTDOMAIN;

                if (CommValue.LANG_VALUE_KOREAN.Equals(Session["LangCd"].ToString()))
                {
                    strMRDFile = "OccupantListKOR_L.mrd";
                }
                else
                {
                    strMRDFile = "OccupantListENG_L.mrd";
                }
            }
