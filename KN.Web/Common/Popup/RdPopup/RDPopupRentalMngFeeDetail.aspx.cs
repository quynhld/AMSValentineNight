...
{
    public partial class RDPopupRentalMngFeeDetail : BasePage
    {
        ...
        private bool CheckParams()
        {
                ...
                strHostIp.Equals(CommValue.PUBLIC_VALUE_TESTDOMAIN.ToLower()))
            {
                ...
                if (strDatum2.Equals(CommValue.FEETY_VALUE_MNGFEE))
                {
                ...
                else if (strDatum2.Equals(CommValue.FEETY_VALUE_RENTALFEE))
                {
