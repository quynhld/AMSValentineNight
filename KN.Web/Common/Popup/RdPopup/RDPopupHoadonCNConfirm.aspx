<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RDPopupHoadonCNConfirm.aspx.cs" Inherits="KN.Web.Common.RdPopup.RDPopupHoadonCNConfirm" %>
...
<html xmlns="http://www.w3.org/1999/xhtml" >
    ...
    <body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style="height:600px; width:723px;">
        ...
        <script language="javascript" id="clientEventHandlersJS" type="text/javascript">
            ...
            Rdviewer.FileOpen('<%=NOW_DOMAIN%>/Common/Mrd/<%=strMRDFile%>', '/rv NewSerialNo[CA/12T] NewInvoiceNo[<%=DOC_NO%>]');
        </script>
