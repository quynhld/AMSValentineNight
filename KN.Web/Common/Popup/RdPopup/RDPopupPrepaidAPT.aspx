<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RDPopupPrepaidAPT.aspx.cs" Inherits="KN.Web.Common.RdPopup.RDPopupPrepaidAPT" %>
...
<head id="Head1" runat="server">
 ...
 <body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style="height:700px; width:1000px;">
        ...
        <script language="javascript" id="clientEventHandlersJS" type="text/javascript">
            ...
            Rdviewer.FileOpen('<%=NOW_DOMAIN%>/Common/Mrd/<%=strMRDFile %>', '/rv Month[<%=strDatum0 %>] MonthE[<%=strDatum1 %>] PaidDt[<%=strDatum2 %>] PaidDtE[<%=strDatum3 %>]');
        </script>
    </body>
</html>