...
{
    public partial class RDPopupSalesContractList : BasePage
    {
        ...
        public string NOW_DOMAIN = CommValue.PUBLIC_VALUE_DOMAIN;
        ...
        private bool CheckParams()
        {
                ...
                strHostIp.Equals(CommValue.PUBLIC_VALUE_TESTDOMAIN.ToLower()))
            {
                ...
                {
                    strMRDFile = "SalesContractListKOR_L.mrd";
                }
                else
                {
                    strMRDFile = "SalesContractListENG_L.mrd";
                }
            }
