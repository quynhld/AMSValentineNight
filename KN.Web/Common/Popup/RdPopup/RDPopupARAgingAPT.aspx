<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RDPopupARAgingAPT.aspx.cs" Inherits="KN.Web.Common.RdPopup.RDPopupARAgingAPT" %>
...
<head id="Head1" runat="server">
 ...
 <body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style="height:700px; width:1000px;">
        ...
        <script language="javascript" id="clientEventHandlersJS" type="text/javascript">
            ...
            Rdviewer.FileOpen('<%=NOW_DOMAIN%>/Common/Mrd/<%=strMRDFile %>', '/rv FeeTy[<%=strDatum0 %>] StartDt[<%=strDatum1 %>] EndDt[<%=strDatum2 %>] RoomNo[<%=strDatum3 %>]');
        </script>7
    </body>
</html>