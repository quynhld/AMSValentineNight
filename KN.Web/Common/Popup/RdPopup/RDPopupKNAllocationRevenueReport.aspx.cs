...
{
    public partial class RDPopupKNAllocationRevenueReport : BasePage
    {
        ...
        private bool CheckParams()
        {
            ...
            if (Request.Params["Datum1"] != null)
            {
                ...
                strDatum1 = strDatum1.Replace("-", "").Substring(0, 4);
            }
                ...
                strHostIp.Equals(CommValue.PUBLIC_VALUE_TESTDOMAIN.ToLower()))
            {
                ...
                if (CommValue.LANG_VALUE_KOREAN.Equals(Session["LangCd"].ToString()))
                {
                    if (strDatum5 == "0001")
                    {
                        strMRDFile = "Allocation_Revenue_L.mrd";
                    }
                    else
                    {
                        strMRDFile = "Allocation_Revenue_RentFee_L.mrd";
                    }
                }
                else
                {
