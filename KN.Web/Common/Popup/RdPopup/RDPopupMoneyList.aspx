<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RDPopupMoneyList.aspx.cs" Inherits="KN.Web.Common.RdPopup.RDPopupMoneyList" %>
...
<head id="Head1" runat="server">
 ...
 <body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style="height:700px; width:1000px;">
        ...
        <script language="javascript" id="clientEventHandlersJS" type="text/javascript">
            ...
            Rdviewer.FileOpen('<%=NOW_DOMAIN%>/Common/Mrd/<%=strMRDFile %>', '/rp [<%=strDatum0%>] [<%=strDatum1%>] [<%=strDatum2%>]');
        </script>
    </body>
</html>