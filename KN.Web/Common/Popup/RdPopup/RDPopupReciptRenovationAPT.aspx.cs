...
{
    public partial class RDPopupReciptRenovationAPT : BasePage
    {
        ...
        private bool CheckParams()
        {
                ...
                strHostIp.Equals(CommValue.PUBLIC_VALUE_TESTDOMAIN.ToLower()))
            {
                ...
                if(strDatum1.Equals("1"))
                {
                    strMRDFile = "EntireReceiptRenovationCNNewAPT_L.mrd";
                }
                else
                {
                    strMRDFile = "EntireReceiptRenovationRCNNewAPT_L.mrd";
                }
