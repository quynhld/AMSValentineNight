<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RDPopupHoaDonParkingMergeAPTPreview.aspx.cs" Inherits="KN.Web.Common.RdPopup.RDPopupHoaDonParkingMergeAPTPreview" %>
...
<html xmlns="http://www.w3.org/1999/xhtml" >
    ...
    <body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style="height:600px; width:723px;">
        ...
        <script language="javascript" id="clientEventHandlersJS" type="text/javascript">
            ...
            Rdviewer.FileOpen('<%=NOW_DOMAIN%>/Common/Mrd/<%=strMRDFile%>', '/rv PayDt[<%=strDatum0%>] PrintDt[<%=strDatum1 %>] RefPrint[<%=strDatum2 %>]');
        </script>
