...
{
    public partial class RDPopupMngPaymentList : BasePage
    {
        ...
        private bool CheckParams()
        {
                ...
                strHostIp.Equals(CommValue.PUBLIC_VALUE_TESTDOMAIN.ToLower()))
            {
                ...
                {
                    strMRDFile = "MngPaymentListKOR_L.mrd";
                }
                else
                {
                    strMRDFile = "MngPaymentListENG_L.mrd";
                }
            }
