<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RDPopupDayAccountInfo.aspx.cs" Inherits="KN.Web.Common.RdPopup.RDPopupDayAccountInfo" %>
...
<head id="Head1" runat="server">
 ...
 <body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style="height:700px; width:1000px;">
        ...
        <script language="javascript" id="clientEventHandlersJS" type="text/javascript">
            ...
            Rdviewer.FileOpen('<%=NOW_DOMAIN%>/Common/Mrd/<%=strMRDFile %>', '/rv FeeTy[<%=strDatum2 %>] StartDt[<%=strDatum0 %>] EndDt[<%=strDatum1 %>] PaymentCd[<%=strDatum4 %>] UserNm[<%=Session["MemNm"].ToString()%>]');
        </script>
    </body>
</html>