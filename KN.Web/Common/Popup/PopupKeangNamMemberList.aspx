<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PopupKeangNamMemberList.aspx.cs" Inherits="KN.Web.Common.Popup.PopupKeangNamMemberList" ValidateRequest="false"%>
    ...
    <form id="frmPopupMemInfo" runat="server">
        <div>
            ...
            <div style="overflow-y:scroll;height:290px;width:622px;">
                <asp:ListView ID="lvMemList" runat="server" ItemPlaceholderID="iphItemPlaceHolderID"
                OnItemCreated="lvMemList_ItemCreated" OnItemDataBound="lvMemList_ItemDataBound">
                    <LayoutTemplate>
                        <table cellspacing="0" class="TbCel-Type4-A iw600">
	                        <colgroup>
                                <col width="30px"/>
