...
{
    public partial class PopupContractDel : BasePage
    {
        ...
        protected void lnkbtnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                objReturn = ContractMngBlo.RemoveRentInfo(txtHfRentCd.Text, Int32.Parse(txtHfRentSeq.Text), txtDelReason.Text, Session["CompCd"].ToString(), Session["MemNo"].ToString(), strIp,ddlCategory.SelectedValue,txtTerminateDt.Text.Replace("-",""));
                ...
                sbInfo.Append("self.close();window.opener.fnChangeList();");
