...
{
    public partial class PopupReleaseCharger : BasePage
    {
        ...
        protected bool CheckParams()
        {
            ...
            if (Request.Params[PARAM_DATA1] != null)
            {
                ...
                {
                    if (Session["ExchageReleaseYn"] != null)
                    {
                        if (Session["ExchageReleaseYn"].ToString().Equals(CommValue.CONCLUSION_TYPE_TEXT_YES))
                        {
                            isCheckOk = CommValue.AUTH_VALUE_TRUE;
                            Session["ExchageReleaseYn"] = null;
