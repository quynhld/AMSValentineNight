...
{
    public partial class PopupKeangNamMemberList : BasePage
    {
        ...
        protected void LoadData()
        {
            ...
            // KN_USP_COMM_SELECT_MEMINFO_S09
            DataTable dtReturn = MemberMngBlo.SpreadKsysKeangNamMemInfo(strMemNo, strMemNm, strAddr, strTel, strCell);
