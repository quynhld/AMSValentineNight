<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Template/MainFrame.Master" AutoEventWireup="true" CodeBehind="UtilFeeReceipt.aspx.cs" Inherits="KN.Web.Management.Remote.UtilFeeReceipt" ValidateRequest="false"%>
    ...
    <ContentTemplate>
        <table class="TypeA" border="0">
            <colgroup>
                ...
                <thead>
                    <tr>
                        <th align="center" class="Fr-line">
                            <asp:CheckBox ID="chkAll" runat="server" AutoPostBack="true" 
                                OnCheckedChanged="chkAll_CheckedChanged" style="text-align:center" />
                        </th>
                        <th class="TbTxtCenter">
                            <asp:Literal ID="ltTopRoomNo" runat="server"></asp:Literal>
                        </th>
                        <th class="TbTxtCenter">
                            <asp:Literal ID="ltTopName" runat="server"></asp:Literal>
                        </th>
                        <th class="TbTxtCenter">
                            <asp:Literal ID="ltTopApplyDt" runat="server"></asp:Literal>
                        </th>
                        <th class="TbTxtCenter">
                            <asp:Literal ID="ltTopElecFee" runat="server"></asp:Literal>
                        </th>
                        <th class="TbTxtCenter">
                            <asp:Literal ID="ltTopWatFee" runat="server"></asp:Literal>
                        </th>
                        <th class="TbTxtCenter">
                            <asp:Literal ID="ltTopGasFee" runat="server"></asp:Literal>
                        </th>
                        <th align="center" class="Ls-line">
                            <asp:Literal ID="ltTopDetailView" runat="server"></asp:Literal>
                        </th>
                    </tr>
                </thead>
            </colgroup>
...
<asp:UpdatePanel ID="upResultList" runat="server" UpdateMode="Conditional">
    ...
    <ContentTemplate>
        <asp:ListView ID="lvUtilFeeList" runat="server" 
            ItemPlaceholderID="iphItemPlaceHolderID" 
            OnItemCreated="lvUtilFeeList_ItemCreated" OnItemDataBound="lvUtilFeeList_ItemDataBound"
            OnItemDeleting="lvRentItemList_ItemDeleting" 
            OnItemUpdating="lvRentItemList_ItemUpdating" 
            OnItemEditing="lvRentItemList_ItemEditing" 
            onselectedindexchanged="lvUtilFeeList_SelectedIndexChanged">
            <LayoutTemplate>
                <table class="TypeA" border="0">
                    <col width="20"/>
                    <col width="70"/>
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td class="TbTxtCenter">
                        <asp:ImageButton ID="imgbtnDetailView" runat="server" ImageAlign="AbsMiddle" ImageUrl="~/Common/Images/Icon/icn_tabIcn.gif"/>
                    </td>
                </tr>
            </ItemTemplate>
            <EmptyDataTemplate>
                <table class="TypeA">
                    <tbody>
                    <tr>
                        <td colspan="12" style="text-align:center"><asp:Literal ID="ltINFO_HAS_NO_DATA" runat="server"></asp:Literal></td>
                    </tr>
                    </tbody>
                </table>
            </EmptyDataTemplate>        
        ...
        <table cellspacing="0"  class="TbCel-Type1 iw840">
            <colgroup>
                ...
                <tr>
                    ...
                    <th align="center">
                        <asp:Literal ID="ltEnterMonth" runat="server"></asp:Literal>
                    </th>
                    <td colspan="2">
                ...
                <tr>
                    <th align="center">
                        <asp:Literal ID="ltElecFee" runat="server"></asp:Literal>
                    </th>
                    <td>
                    ...
                    <th align="center">
                        <asp:Literal ID="ltWatFee" runat="server"></asp:Literal>
                    </th>
                    <td>
                    ...
                    <th align="center">
                        <asp:Literal ID="ltGasFee" runat="server"></asp:Literal>
                    </th>
                    <td>
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <asp:DropDownList ID="ddlPaymentCd" runat="server" AutoPostBack="true" 
                            OnSelectedIndexChanged="ddlPaymentCd_SelectedIndexChanged">
                        </asp:DropDownList>
