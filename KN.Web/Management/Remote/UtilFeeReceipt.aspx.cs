...
{
    public partial class UtilFeeReceipt : BasePage
    {
        ...
        private void LoadData()
        {
            ...
            // KN_USP_MNG_SELECT_MONTHENERGY_S04
            dtReturn = RemoteMngBlo.SpreadMonthUseEnergyList(ddlInsRentCd.SelectedValue, txtInsRoomNo.Text, ddlPaidCd.SelectedValue);
                                    ...
                                    if (((CheckBox)lvUtilFeeList.Items[intTmpI].FindControl("chkElecItem")).Checked)
                                    {
                                        ...
                                        if (!string.IsNullOrEmpty(txtElecFee.Text))
                                        {
                                            if (double.Parse(txtElecFee.Text) > CommValue.NUMBER_VALUE_0_0)
                                            {
                                                ...
                                                // 3. 전기세 수납
                                                // KN_USP_MNG_UPDATE_MONTHENERGY_S00
                                                DataTable dtUtilReturn = RemoteMngBlo.ModifyUtilityFee(strRentCd, CommValue.CHARGETY_VALUE_ELECTRICITY, txtHfEnergyMonth.Text, strRoomNo, strPaymentCd,
                                                ...
                                                if (dtUtilReturn != null)
                                                {
                                                    if (dtUtilReturn.Rows.Count > CommValue.NUMBER_VALUE_0)
                                                    {
                                                        ...
                                                        // KN_USP_MNG_UPDATE_MONTHENERGY_M02
                                                        if (txtElecFee.Text.Equals(txtHfElecFee.Text))
                                                        {
                                                            RemoteMngBlo.ModifyMonthReceit(strRentCd, txtHfEnergyMonth.Text.Substring(0, 6), strRoomNo, CommValue.CHARGETY_VALUE_ELECTRICITY, CommValue.PAYMENT_TYPE_VALUE_PAID);
                                                        }

                                                        // 6. Utility Fee Sequence 할당
                                                        // KN_USP_MNG_UPDATE_MONTHENERGY_M03
                                                        RemoteMngBlo.ModifyMonthEnergySeq(strRentCd, txtHfEnergyMonth.Text.Substring(0, 6), strRoomNo, CommValue.CHARGETY_VALUE_ELECTRICITY, intPaySeq, strNowDt, intPaymentSeq);
                                    ...
                                    if (((CheckBox)lvUtilFeeList.Items[intTmpI].FindControl("chkWatItem")).Checked)
                                    {
                                        ...
                                        if (!string.IsNullOrEmpty(txtWatFee.Text))
                                        {
                                            if (double.Parse(txtWatFee.Text) > CommValue.NUMBER_VALUE_0_0)
                                            {
                                                ...
                                                // 3. 수도세 수납
                                                // KN_USP_MNG_UPDATE_MONTHENERGY_S00
                                                DataTable dtUtilReturn = RemoteMngBlo.ModifyUtilityFee(strRentCd, CommValue.CHARGETY_VALUE_WATER, txtHfEnergyMonth.Text, strRoomNo, strPaymentCd,
                                                                                                       dblPayedFee, Session["CompCd"].ToString(), Session["MemNo"].ToString());
                                                ...
                                                if (dtUtilReturn != null)
                                                {
                                                    if (dtUtilReturn.Rows.Count > CommValue.NUMBER_VALUE_0)
                                                    {
                                                        ...
                                                        {
                                                            RemoteMngBlo.ModifyMonthReceit(strRentCd, txtHfEnergyMonth.Text.Substring(0, 6), strRoomNo, CommValue.CHARGETY_VALUE_WATER, CommValue.PAYMENT_TYPE_VALUE_PAID);
                                                        }

                                                        // 6. Utility Fee Sequence 할당
                                                        // KN_USP_MNG_UPDATE_MONTHENERGY_M03
                                                        RemoteMngBlo.ModifyMonthEnergySeq(strRentCd, txtHfEnergyMonth.Text.Substring(0, 6), strRoomNo, CommValue.CHARGETY_VALUE_WATER, intPaySeq, strNowDt, intPaymentSeq);
                                    ...
                                    if (((CheckBox)lvUtilFeeList.Items[intTmpI].FindControl("chkGasItem")).Checked)
                                    {
                                        ...
                                        if (!string.IsNullOrEmpty(txtGasFee.Text))
                                        {
                                            if (double.Parse(txtGasFee.Text) > CommValue.NUMBER_VALUE_0_0)
                                            {
                                                ...
                                                // 3. 가스비 수납
                                                // KN_USP_MNG_UPDATE_MONTHENERGY_S00
                                                DataTable dtUtilReturn = RemoteMngBlo.ModifyUtilityFee(strRentCd, CommValue.CHARGETY_VALUE_GAS, txtHfEnergyMonth.Text, strRoomNo, strPaymentCd,
                                                                                                       dblPayedFee, Session["CompCd"].ToString(), Session["MemNo"].ToString());
                                                ...
                                                if (dtUtilReturn != null)
                                                {
                                                    if (dtUtilReturn.Rows.Count > CommValue.NUMBER_VALUE_0)
                                                    {
                                                        ...
                                                        {
                                                            RemoteMngBlo.ModifyMonthReceit(strRentCd, txtHfEnergyMonth.Text.Substring(0, 6), strRoomNo, CommValue.CHARGETY_VALUE_GAS, CommValue.PAYMENT_TYPE_VALUE_PAID);
                                                        }

                                                        // 6. Utility Fee Sequence 할당
                                                        // KN_USP_MNG_UPDATE_MONTHENERGY_M03
                                                        RemoteMngBlo.ModifyMonthEnergySeq(strRentCd, txtHfEnergyMonth.Text.Substring(0, 6), strRoomNo, CommValue.CHARGETY_VALUE_GAS, intPaySeq, strNowDt, intPaymentSeq);
        ...
        protected void lvRentItemList_ItemUpdating(object sender, ListViewUpdateEventArgs e)
        {
            ...
            // 완납처리
            // KN_USP_MNG_UPDATE_MONTHENERGY_M02
            RemoteMngBlo.ModifyMonthReceit(txtHfRentCd.Text, txtHfEnergyMonth.Text, txtHfRoomNo.Text, CommValue.CHARGETY_VALUE_ELECTRICITY, CommValue.PAYMENT_TYPE_VALUE_PAID);
        ...
        protected void lvRentItemList_ItemDeleting(object sender, ListViewDeleteEventArgs e)
        {
            ...
            // 완납처리
            // KN_USP_MNG_UPDATE_MONTHENERGY_M02
            RemoteMngBlo.ModifyMonthReceit(txtHfRentCd.Text, txtHfEnergyMonth.Text, txtHfRoomNo.Text, CommValue.CHARGETY_VALUE_WATER, CommValue.PAYMENT_TYPE_VALUE_PAID);
        ...
        protected void lvRentItemList_ItemEditing(object sender, ListViewEditEventArgs e)
        {
            ...
            // 완납처리
            // KN_USP_MNG_UPDATE_MONTHENERGY_M02
            RemoteMngBlo.ModifyMonthReceit(txtHfRentCd.Text, txtHfEnergyMonth.Text, txtHfRoomNo.Text, CommValue.CHARGETY_VALUE_GAS, CommValue.PAYMENT_TYPE_VALUE_PAID);
        ...
        protected void lnkbtnExcelReport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                // KN_USP_MNG_SELECT_MONTHENERGY_S08
                dtReturn = RemoteMngBlo.SpreadMonthExcelEnergyList(ddlYear.SelectedValue, ddlMonth.SelectedValue);
        ...
        protected void lvUtilFeeList_SelectedIndexChanged(object sender, EventArgs e)
        {
