<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Template/MainFrame.Master" AutoEventWireup="true" CodeBehind="MngReadMonthForRoom.aspx.cs" Inherits="KN.Web.Management.Remote.MngReadMonthForRoom" ValidateRequest="false" %>
...
//-->
    ...
    <fieldset class="sh-field2">
        ...
        <ul class="sf2-ag MrgL10">
            ...
            <li>
                <div class="Btn-Type1-wp Mrg0" style="display: none">
                    <div class="Btn-Tp-L">
                        <div class="Btn-Tp-R">
                            <div class="Btn-Tp-M">
    ...
    <asp:UpdatePanel ID="upSearch" runat="server" UpdateMode="Conditional">
        ...
        <ContentTemplate>
        <div style="height: 460px;overflow-y: scroll;overflow-x: hidden;width: 840px">
            <asp:ListView ID="lvDayChargeList" runat="server" ItemPlaceholderID="iphItemPlaceHolderID"
                ...
                <ItemTemplate>
                    <tr style="background-color:#FFFFFF;cursor:pointer;" onmouseover="this.style.backgroundColor='#E4EEF5'" onmouseout="this.style.backgroundColor='#FFFFFF'" onclick='javascript:fnDetailView("<%#Eval("RoomNo")%>","<%#Eval("USeq")%>");'>
