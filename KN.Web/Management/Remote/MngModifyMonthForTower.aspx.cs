...
{
    public partial class MngModifyMonthForTower : BasePage
    {
        ...
        protected void LoadData()
        {
            ...
            dsReturn = RemoteMngBlo.SpreadMonthChargeListForTower(CommValue.BOARD_VALUE_PAGESIZE, Int32.Parse(hfCurrentPage.Value), txtHfRentCd.Text, txtHfChargeTy.Text, ddlYear.Text, ddlMonth.Text, txtSearchRoom.Text);
        ...
        protected void lvMonthChargeList_ItemDataBound(object sender, ListViewItemEventArgs e)
        {
            if (e.Item.ItemType.Equals(ListViewItemType.DataItem))
            {
                ...
                if (!string.IsNullOrEmpty(drView["GenVal"].ToString()))
                {
                    txtNightUse.Text = double.Parse(drView["PeakUse"].ToString()).ToString("###,##0.##");
