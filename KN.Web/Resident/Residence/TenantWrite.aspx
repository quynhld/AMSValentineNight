<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Template/MainFrame.Master" AutoEventWireup="true" CodeBehind="TenantWrite.aspx.cs" Inherits="KN.Web.Resident.Residence.TenantWrite"  ValidateRequest="false"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContent" runat="server">
    ...
    <table class="TbCel-Type2-A">
	    ...
	    <tr>
		    ...
		    <td colspan="3">
		        <asp:TextBox ID="txtBirthDt" runat="server" CssClass="bgType2 cssCalendar" Width="80px" ReadOnly="true"></asp:TextBox>
	    ...
	    <tr>
		    ...
		    <td colspan="5">
		        <asp:TextBox ID="txtOccupationDt" runat="server" CssClass="bgType2 cssCalendar" Width="80px" ReadOnly="true"></asp:TextBox>
    ...
    <div style="overflow-y:scroll;height:60px;width:820px;">
        <asp:ListView ID="lvMngAddon" runat="server" ItemPlaceholderID="iphItemPlaceHolderID" OnItemDataBound="lvMngAddon_ItemDataBound" 
            OnItemCreated="lvMngAddon_ItemCreated" OnItemDeleting="lvMngAddon_ItemDeleting" OnItemUpdating="lvMngAddon_ItemUpdating">
            <LayoutTemplate>
    ...
    <div style="overflow-y:scroll;height:60px;width:820px;">
        <asp:ListView ID="lvMngCardList" runat="server" ItemPlaceholderID="iphItemPlaceHolderID" OnItemDataBound="lvMngCardList_ItemDataBound" 
            OnItemCreated="lvMngCardList_ItemCreated" OnItemDeleting="lvMngCardList_ItemDeleting" OnItemUpdating="lvMngCardList_ItemUpdating">
            <LayoutTemplate>
