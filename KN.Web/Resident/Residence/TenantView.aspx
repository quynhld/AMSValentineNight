<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Template/MainFrame.Master" AutoEventWireup="true" CodeBehind="TenantView.aspx.cs" Inherits="KN.Web.Resident.Residence.TenantView" ValidateRequest="false"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContent" runat="server">
    <div style="overflow-y:scroll;height:490px;width:840px;">
	    ...
	    <table class="TbCel-Type2 iw820">
		    ...
		    <tr>
			    <th class="Bd-bt"><asp:Literal ID="ltGender" runat="server"></asp:Literal></th>
			    <td class="Bd-bt"><asp:Literal ID="ltInsGender" runat="server"></asp:Literal></td>
			    <th class="Bd-bt Bd-Lt"><asp:Literal ID="ltOccupationDt" runat="server"></asp:Literal></th>
			    <td class="Bd-bt"><asp:Literal ID="ltInsOccupationDt" runat="server"></asp:Literal></td>
		    </tr>
		    <tr>
		    ...
		    <tr>
			    <th rowspan="2" style="height:52px"><asp:Literal ID="ltTaxAddr" runat="server"></asp:Literal> (For Tax)</th>
			    <td colspan="3" style="height:26px"><asp:Literal ID="ltInsTaxAddr" runat="server"></asp:Literal></td>
		    </tr>
		    <tr>
			    <td colspan="3" style="height:26px"><asp:Literal ID="ltInsTaxDetAddr" runat="server"></asp:Literal></td>
		    </tr>
		    <tr>
