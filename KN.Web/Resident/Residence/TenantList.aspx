<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Template/MainFrame.Master" AutoEventWireup="true" CodeBehind="TenantList.aspx.cs" Inherits="KN.Web.Resident.Residence.TenantList" ValidateRequest="false"%>
...
<script language="javascript" type="text/javascript">
    ...
    function fnOccupantList()
    {
        ...
        window.open("/Common/RdPopup/RDPopupTenantList.aspx?Datum0=" + strData, "TenantList", "status=no, resizable=no, width=1000, height=700, left=100,top=100, scrollbars=no, menubar=no, toolbar=no, location=no");
        return false;
    }
	        ...
	        <div class="Btn-Tp3-R">
		        <div class="Btn-Tp3-M">
			        <span><asp:LinkButton ID="lnkbtnReport" runat="server" 
                        OnClientClick="javascript:return fnOccupantList();" 
