...
{
    public partial class TenantView : BasePage
    {
        ...
        protected void LoadData()
        {
            ...
            var dsReturn = ResidentMngBlo.WatchRentUserView(txtHfUserSeq.Text, txtHfRentCd.Text, Int32.Parse(txtHfRentSeq.Text), Session["LangCd"].ToString());
        ...
        protected void BindMainInfo(DataTable dtParam)
        {
            ...
            if (dtParam.Rows.Count > 0)
            {
                ...
                {
                    ltKsystemCode.Text = TextLib.StringDecoder(dtParam.Rows[0]["KSys_CustCd"].ToString());
                }
            }
        }
