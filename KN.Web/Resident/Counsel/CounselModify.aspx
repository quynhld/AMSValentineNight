<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Template/MainFrame.Master" AutoEventWireup="true" CodeBehind="CounselModify.aspx.cs" Inherits="KN.Web.Resident.Counsel.CounselModify" ValidateRequest="false"%>
...
<asp:UpdatePanel ID="upPanel" UpdateMode="Conditional" runat="server">
    ...
    <ContentTemplate>
        <table cellspacing="0" class="TbCel-Type2">
            <colgroup>
                <col width="140px"/>
                <col width="185px"/>
                <col width="140px"/>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            &nbsp;<asp:TextBox ID="txtEtcCurrRental" runat="server" Width="60" MaxLength="10" ReadOnly="true" Enabled="false" CssClass="bgType2"></asp:TextBox>
                        ...
                        <td>
                            <asp:TextBox ID="txtCurrMng" runat="server" Width="60" MaxLength="10" CssClass="bgType2"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            ...
                            &nbsp;<asp:TextBox ID="txtEtcCurrFare" runat="server" Width="80" MaxLength="10" ReadOnly="true" Enabled="false" CssClass="bgType2"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <th class="lebd">
                            <asp:Literal ID="ltTitleMotorBike" runat="server"></asp:Literal>
                        </th>
                        <td>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <asp:TextBox ID="txtBudgetTrans" runat="server" Width="80" MaxLength="10" CssClass="bgType2"></asp:TextBox>
                ...
                <tbody>
                    <tr>
                        ...
                        <td colspan="3">
                            ...
                            &nbsp;<asp:TextBox ID="txtEtcLeaseAreaInNeed" runat="server" Width="80" MaxLength="10" ReadOnly="true" Enabled="false" CssClass="bgType2"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            ...
                            &nbsp;<asp:TextBox ID="txtEtcExpectedRentals" runat="server" Width="80" MaxLength="10" ReadOnly="true" Enabled="false" CssClass="bgType2"></asp:TextBox>
                            <asp:Literal ID="ltTitleDollar3" runat="server"></asp:Literal>
                        </td>
                    </tr>
                    <tr>
                        <th><asp:Literal ID="ltTitleFavorateFloor" runat="server"></asp:Literal></th>
                        <td><asp:TextBox ID="txtFavorateFloor" runat="server" Width="80" MaxLength="10" CssClass="bgType2"></asp:TextBox></td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtCompBudgert" runat="server" Width="80" MaxLength="10" CssClass="bgType2"></asp:TextBox>
