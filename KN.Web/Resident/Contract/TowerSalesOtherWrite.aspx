<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Template/MainFrame.Master" AutoEventWireup="true" CodeBehind="TowerSalesOtherWrite.aspx.cs" Inherits="KN.Web.Resident.Contract.TowerSalesOtherWrite" ValidateRequest="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContent" runat="server">
    ...
    function fnCheckValidate(strAlertText, strTanVal, strLongVal, strShortVal)
    {
        ...
        var strDdlFirst = document.getElementById("<%=ddlFirst.ClientID %>");
        var strDdlSecond = document.getElementById("<%=ddlSecond.ClientID %>");
        var strDdlThird = document.getElementById("<%=ddlThird.ClientID %>");
        var strDdlFouth = document.getElementById("<%=ddlFouth.ClientID %>");
        var strDdlFifth = document.getElementById("<%=ddlFifth.ClientID %>");
        var strDdlSixth = document.getElementById("<%=ddlSixth.ClientID %>");
        var strDdlSeventh = document.getElementById("<%=ddlSeventh.ClientID %>");
        var strDdlEighth = document.getElementById("<%=ddlEighth.ClientID %>");
        ...
        var strPayStartYYYYMM = document.getElementById("<%=txtPayStartYYYYMM.ClientID %>");
...
//        }
        ...
        if (trim(strDdlSixth.value) != "")
        {
            if (trim(strDdlSeventh.value) == "")
            {
                alert(strAlertText);
                strDdlSeventh.focus();
                return false;
    ...
    function fnApplyFee() {
        if(!$("#isApplyFeeMn").is(':checked')) {
            $("#listFitOutFee").hide("slow"); // checked
            $('#hfIsApplyFeeMn').val("N");
            $('#<%=hfApplyFeeMn.ClientID%>').val("Y"); 
            $('#lineRow').attr("style", "");
        } else {
            $("#listFitOutFee").show("slow");
            $('#hfIsApplyFeeMn').val("Y");
            $('#<%=hfApplyFeeMn.ClientID%>').val("Y");            
 ...
 function loadCalendar() {
    ...
    $( "#<%=txtRSIsueDate.ClientID %>" ).datepicker();
    $( "#<%=txtMSisueDate.ClientID %>" ).datepicker();     
    ...
    function AddRentFee(){
        ...
        if (feeNo!="") {
            ...
            $('#tblListRentFee tbody').append(''+
                '<tr id="rentfeeNum'+rentFeeNum+'" ><td align="left" class="P0"><input name="" type="text" maxlength="10" readonly="readonly" id="" class="grBg bgType1" style="width:70px;margin-left: 48px;" value="'+stSDate+'">' +
                '</td>'+
                '<td align="left" class="P0">'+
                ' <input name="" type="text" maxlength="10" readonly="readonly" id="" class="grBg bgType1" style="width:70px;margin-left: 48px;" value="'+stEDate+'">'+
                '</td>'+
    ...
    function editFitFee(feeNum) {    
        $('#txtFitFeeStartDt').val($("#feeNum" + feeNum + " :text").eq(0).val());
        $('#txtFitFeeEndDt').val($("#feeNum" + feeNum + " :text").eq(1).val());
        $('#txtFitFeeExcRate').val($("#feeNum" + feeNum + " :text").eq(2).val());
        $('#txtFeeExpAmt').val($("#feeNum" + feeNum + " :text").eq(3).val());
        $('#feeID').val(feeNum);
    }
...
//-->  
 ...
 function VNDtoUSDDeposit() {
           var currentFc = $('#<%= txtExchangeRate.ClientID %>').val();
            ...
            var num2 = $("#<%=txtSumDepositVNDNo.ClientID %>").val();
           if (num2=="") {
               return; 
           }   
       var result = parseFloat(num2, 10) / parseFloat(currentFc, 10);
        
        $('#<%=txtSumDepositUSDNo.ClientID %>').val(result.toFixed(2)); 
        $("#<%=txtSumDepositVNDNo.ClientID %>").val(parseFloat(num2).toFixed(2));
 }

 function USDtoVNDDeposit() {
           var currentFc = $('#<%= txtExchangeRate.ClientID %>').val();
           
            var num2 = $("#<%=txtSumDepositUSDNo.ClientID %>").val();
           if (num2=="") {
               return; 
           }
       var result = parseFloat(num2, 10) * parseFloat(currentFc, 10);
 ...
 function rentUSDtoVND() {
    ...
    <div class="Tab-wp MrgB10">
        <ul class="TabM">
            <li class="title"><asp:LinkButton ID="lnkOtherContract" runat="server" 
                    Text="Normal Contract" onclick="lnkOtherContract_Click" ></asp:LinkButton></li>                        
            <li class="Over CursorNon">Other Contract</li>
        ...
        <ContentTemplate>
            ...
            <table cellspacing="0" class="TbCel-Type2-A">
                <colgroup>
                    <col width="147px" />
                    <caption>
                        Pro 서버에서도 원활한 작동을 위해 js 데이터 정보를 수정해 달라는 요청을 받았습니다.
                        <colgroup>
                            <col width="178px" />
                            <col width="147px" />
                            <col width="178px" />
                            <tbody>
                               <tr>
                                ...
                                <tr>
                                    <th rowspan="2">
                                        <asp:Literal ID="ltRentAddr" runat="server"></asp:Literal>
                                        &nbsp;(For Tax)
                                    </th>
                                    <td colspan="3">
                ...
                <colgroup>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <%--<asp:TextBox ID="txtRoomNo" runat="server" MaxLength="10" AutoPostBack="true" CssClass="bgType2" OnTextChanged="txtRoomNo_TextChanged" Visible="false"></asp:TextBox>--%>
                                <asp:DropDownList ID="ddlFirst" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlFirst_SelectedIndexChanged">
                                ...
                                <asp:DropDownList ID="ddlSecond" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlSecond_SelectedIndexChanged">
                                </asp:DropDownList>
                                <asp:DropDownList ID="ddlThird" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlThird_SelectedIndexChanged">
                                </asp:DropDownList>
                                <asp:DropDownList ID="ddlFouth" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlFouth_SelectedIndexChanged">
                                </asp:DropDownList>
                                <asp:DropDownList ID="ddlFifth" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlFifth_SelectedIndexChanged">
                                </asp:DropDownList>
                                <asp:DropDownList ID="ddlSixth" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlSixth_SelectedIndexChanged">
                                    <asp:ListItem Text="" Value=""></asp:ListItem>
                                    <asp:ListItem Text="-" Value="-"></asp:ListItem>
                                </asp:DropDownList>
                                <asp:DropDownList ID="ddlSeventh" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlSeventh_SelectedIndexChanged">
                                </asp:DropDownList>
                                <asp:DropDownList ID="ddlEighth" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlEighth_SelectedIndexChanged">
                                </asp:DropDownList>
                        ...
                        <tr>
                            <th><asp:Literal ID="ltExchangeRate" runat="server"></asp:Literal></th>
                             ...
                             <td colspan="2" style="width: 157px">
                                <asp:TextBox ID="txtExchangeRate" runat="server" AutoPostBack="False" CssClass="bgType2" MaxLength="10" ReadOnly="True"></asp:TextBox>
...
<asp:UpdatePanel ID="upDeposit" runat="server">
        ...
        <ContentTemplate>
            ...
            <table class="TbCel-Type4-A" style="display: none">
                <colgroup>
                    <col width="164px" />
                    <col width="164px" />
                    <col width="104px" />
            ...
            <table cellspacing="0" class="TbCel-Type2-A">
                <colgroup>
                    ...
                    <tbody>
                        <tr>
                            <th>
                                <asp:Literal ID="ltPayStartYYYYMM" runat="server"></asp:Literal>&nbsp;(YYYYMM)
                            </th>
                            <td>
                                <asp:TextBox ID="txtPayStartYYYYMM" runat="server" MaxLength="6" Width="100" CssClass="bgType2"></asp:TextBox>
                                <asp:Literal ID="ltPayStartYYYYMMUnit" runat="server"></asp:Literal>
                            </td>
                            <th class="lebd">
                        ...
                        <tr>
                            <th>
                                <asp:Literal ID="Literal1" runat="server" Text="Start Isue Date"></asp:Literal>
                            </th>
                            <td >
                                <asp:TextBox ID="txtRSIsueDate" runat="server" MaxLength="2" Width="100" CssClass="bgType2" ></asp:TextBox>                                     
                                <img align="absmiddle" alt="Calendar" onclick="CallCalendar('#<%=txtRSIsueDate.ClientID %>')"
                                    src="/Common/Images/Common/calendar.gif" style="cursor: pointer;" value="" />
                            </td>
                            <th>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlRPaymentCycle" runat="server" AutoPostBack="False">
                                    <asp:ListItem Text="B" Value="M">By month</asp:ListItem>
                                    <asp:ListItem Text="O" Value="Q">By quarter</asp:ListItem>
                                </asp:DropDownList>                                 
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtSumRentVNDNo" runat="server" MaxLength="18" Width="100" CssClass="bgType3"
                            ...
                            <td>
                                <asp:TextBox ID="txtSumRentUSDNo" runat="server" MaxLength="18" Width="100" CssClass="bgType3"
                                    AutoPostBack="true" OnTextChanged="txtSumRentUSDNo_TextChanged"></asp:TextBox>
                        ...
                        <colgroup>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <th align="center" class="P0">
                                        <asp:Literal ID="ltTopRentalFeeRate" runat="server"></asp:Literal>
                                    </th>
                                    <th align="center" class="P0">
                        ...
                        <colgroup>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td align="center" class="P0">
                                        <input id="txtRentalFeeEndDt"  class="grBg bgType2" maxlength="10"
                                            style="width:70px;" ></input>
                                    ...
                                    <td align="center" class="P0">
                                        <input id="txtRentalFeeExcRate"  maxlength="18"  style="width:70px;" onblur="rentVNDtoUSD()" onkeypress="javascript:IsNumeric(this, 'Please enter only numbers.');"></input>
                                        <asp:Literal ID="ltRentalFeeExcRateUnit" runat="server"></asp:Literal>
                                    </td>
                                    <td align="center" class="P0">
                                        <input id="txtRentalFeeExpAmt"  maxlength="18"  style="width:70px;" onblur="rentUSDtoVND()" onkeypress="javascript:IsNumeric(this, 'Please enter only numbers.');"></input>                                       
                ...
                <colgroup>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td align="center" class="P0">                              
                                <input type="text" id="txtFitFeeExcRate"  maxlength="10" style="width: 70px" 
                                    onblur="fitVNDtoUSD()" onkeypress="javascript:IsNumeric(this, 'Please enter only numbers.');" />
                                VND
                            </td>
                            <td align="center" class="P0">                               
                                <input type="text" id="txtFitFeeExpAmt"  maxlength="18"  style="width: 70px" 
                                    onblur="fitUSDtoVND();" onkeypress="javascript:IsNumeric(this, 'Please enter only numbers.');"/>
                                $
                            </td>
                            <td align="center" class="P0">
                                <span>
                ...
                <colgroup>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <th>
                                <asp:Literal ID="Literal2" runat="server" Text="Start Isue Date"></asp:Literal>

                            </th>
                            <td >
                                <asp:TextBox ID="txtMSisueDate" runat="server" MaxLength="2" Width="100" CssClass="bgType2" ></asp:TextBox>                                     
                                <img align="absmiddle" alt="Calendar" onclick="CallCalendar('#<%=txtMSisueDate.ClientID %>')"
                                    src="/Common/Images/Common/calendar.gif" style="cursor: pointer;"  />
                ...
                <colgroup>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td align="center" class="P0">                              
                                <input type="text" id="txtFeeExcRate"  maxlength="10" style="width: 70px" onblur="VNDtoUSD()" onkeypress="javascript:IsNumeric(this, 'Please enter only numbers.');"/>
                                VND
                            </td>
                            <td align="center" class="P0">                               
                                <input type="text" id="txtFeeExpAmt"  maxlength="18"  style="width: 70px" onblur="USDtoVND();" onkeypress="javascript:IsNumeric(this, 'Please enter only numbers.');"/>
                                $
                            </td>
                            <td align="center" class="P0">
                                <span>
