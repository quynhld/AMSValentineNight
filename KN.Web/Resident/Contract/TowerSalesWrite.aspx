...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContent" runat="server">
    ...
    {
        var strDepositExpDt = document.getEleme("<%=txtDepositExpDt.ClientID %>");
...
//        }
 ...
 function loadCalendar() {
    ...
    $("#<%=txtPayStartYYYYMM.ClientID %>").datepicker();
...
<asp:UpdatePanel ID="upDeposit" runat="server">
    ...
    <!--// 임대료 (월간 임대료) //-->
    <asp:UpdatePanel ID="upRentalFee" runat="server" UpdateMode="Conditional">
        <Triggers>
        </Triggers>
        <ContentTemplate>
