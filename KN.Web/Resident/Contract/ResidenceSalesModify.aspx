<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Template/MainFrame.Master"
    AutoEventWireup="true" CodeBehind="ResidenceSalesModify.aspx.cs" Inherits="KN.Web.Resident.Contract.ResidenceSalesModify"
...
//                  //  if ($(this).eq(0).val()=="Y" && $(this).attr("id")=="isNew") {                      
//                    if($(this).val()!="|") {
...
//                $('#<%=hfListFeeMng.ClientID %>').val(strListFitFee);            
//            }        
            getListFeeMng();
            getListFitFeeMng();
            return true;
    ...
    function getListFitFeeMng() {
        ...
        function fnApplyFee() {
            if(!$("#<%=isApplyFeeMn.ClientID %>").is(':checked')) {
                $("#<%=ListFitOutFee.ClientID %>").hide("slow"); // checked0
                $('#<%=hfIsApplyFeeMn.ClientID%>').val("N");
                $('#<%=lineRow.ClientID %>').attr("style", "");           
            } else {
                $("#<%=ListFitOutFee.ClientID %>").show("slow");
        ...
        function loadCalendar() { 
            ...
            $("#<%=txtInitMMMngDt.ClientID %>").datepicker({
                //altField: "#<%=hfPlusCondDt.ClientID %>"
            });
            initControl();         
        ...
        function VNDtoUSD(vnd,usd) {
            var currentFc = $('#<%= hfExchangeRate.ClientID %>').val();
            ...
            $("#"+vnd).val(parseFloat(num2).toFixed(2));
        }

        function USDtoVND(usd,vnd) {
            var currentFc = $('#<%= hfExchangeRate.ClientID %>').val();
            ...
            $('#'+vnd).val(result.toFixed(2));  
            $("#"+usd).val(parseFloat(num2).toFixed(2));
        }
    ...
    function isValidateFee(sdate,edate,vnd,usd) {
        ...
        function editFee(feeNum) {    
            $('#txtFeeStartDt').val($("#" + feeNum+" :text").eq(0).val());
            $('#txtFeeEndDt').val($("#" + feeNum + " :text").eq(1).val());
            $('#txtFeeExcRate').val($("#" + feeNum + " :text").eq(2).val());
            $('#txtFeeExpAmt').val($("#" + feeNum + " :text").eq(3).val());
            $('#feeID').val(feeNum);
        }
    
        function editFeeN(feeNum) {    
            $('#txtFeeStartDt').val($("#" + feeNum.id+" :text").eq(0).val());
            $('#txtFeeEndDt').val($("#" + feeNum.id + " :text").eq(1).val());
            $('#txtFeeExcRate').val($("#" + feeNum.id + " :text").eq(2).val());
            $('#txtFeeExpAmt').val($("#" + feeNum.id + " :text").eq(3).val());
            $('#feeID').val(feeNum.id);
        } 
    
        function deleteFee(thisFee) {
            if ($("#" + thisFee + " :hidden").eq(1).val()!='') {
                $('#<%=hfFeeSeqDel.ClientID %>').val($("#" + thisFee + " :hidden").eq(1).val());
...
//-->        
    ...
    <asp:UpdatePanel ID="upBasicInfo" runat="server" UpdateMode="Conditional">
        <Triggers>
            ...
            <asp:AsyncPostBackTrigger ControlID="imgDeleteFee" EventName="Click" />
            <asp:AsyncPostBackTrigger ControlID="isApplyFeeMn" EventName="CheckedChanged" />
        ...
        <ContentTemplate>
            ...
            <table cellspacing="0" class="TbCel-Type2-A">
                <colgroup>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th>
                                <asp:Literal ID="Literal3" runat="server" Text="Sub Lessor Of"></asp:Literal>
                            </th>
                            <td colspan="3">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtExpiringDt" runat="server" CssClass="grBg bgType3" MaxLength="10"
                                    Width="70" ReadOnly="false"></asp:TextBox>
            ...
            <asp:UpdatePanel runat="server" ID="upBasicInfo1" UpdateMode="Conditional">
                <Triggers>
                ...
                <colgroup>
                    ...
                    <tbody>
                        <tr style="display: none">
                            ...
                            <td colspan="2">
                                1 Dollar :
                                <asp:TextBox ID="txtExchangeRate" runat="server" ReadOnly="true" CssClass="bgType2"></asp:TextBox>
            ...
            <table cellspacing="0" class="TbCel-Type2-A">
                ...
                <tbody>
                    <tr>
                        ...
                        <td colspan="2">
                            <asp:TextBox ID="txtFC" runat="server" CssClass="bgType2" MaxLength="10"></asp:TextBox>
                            <asp:CheckBox ID="chkCC" runat="server" Text="Current Currency" Checked="True" />
                        ...
                        <td>
                            <asp:TextBox ID="txtFloation" runat="server" AutoPostBack="true" CssClass="bgType2"
                                MaxLength="3" Width="67px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <th>
                ...
                <colgroup>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtInitMMMngDay" runat="server" MaxLength="18" Width="100" CssClass="bgType2"></asp:TextBox>
                                <asp:Literal ID="txtInitMMMngDayUnit" runat="server"></asp:Literal>
                            </td>
                            <th class="lebd">
                                <asp:Literal ID="ltInitMMMngDt" runat="server"></asp:Literal>
                            </th>
                            <td>
                                <asp:TextBox ID="txtInitMMMngDt" runat="server" CssClass="grBg bgType1" MaxLength="10"
                                    Width="70" ReadOnly="true"></asp:TextBox>
                                <img align="absmiddle" alt="Calendar" onclick="CallCalendar('#<%=txtInitMMMngDt.ClientID%>')"
                                    src="/Common/Images/Common/calendar.gif" style="cursor: pointer;" value="" />
                                <asp:HiddenField ID="hfInitMMMngDt" runat="server" />
                            </td>
                        </tr>
                    </tbody>
                </colgroup>
                    ...
                    <colgroup>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td align="center" class="P0">
                                    <input type="text" id="txtFeeExcRate" maxlength="10" style="width: 70px" onblur="VNDtoUSD('txtFeeExcRate','txtFeeExpAmt')"
                                        onkeypress="javascript:IsNumericOrDot(this, 'Please enter only numbers.');" />
                                    VND
                                </td>
                                <td align="center" class="P0">
                                    <input type="text" id="txtFeeExpAmt" maxlength="18" style="width: 70px" onblur="USDtoVND('txtFeeExpAmt','txtFeeExcRate');"
                                        onkeypress="javascript:IsNumericOrDot(this, 'Please enter only numbers.');" />
                                    $
                                </td>
                                <td align="center" class="P0">
            ...
            <div class="Tb-Tp-tit">
                ...
                <div style="float: right" id="chkUsingMnFee" runat="server">
                    <asp:CheckBox ID="isApplyFeeMn" runat="server" Checked="True" OnCheckedChanged="isApplyFeeMn_CheckedChanged" />Apply
                    Fee Management
                </div>
                    ...
                    <colgroup>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td align="center" class="P0">
                                    <input type="text" id="txtFitFeeExcRate" maxlength="10" style="width: 70px" onblur="VNDtoUSD('txtFitFeeExcRate','txtFitFeeExpAmt')"
                                        onkeypress="javascript:IsNumericOrDot(this, 'Please enter only numbers.');" />
                                    VND
                                </td>
                                <td align="center" class="P0">
                                    <input type="text" id="txtFitFeeExpAmt" maxlength="18" style="width: 70px" onblur="USDtoVND('txtFitFeeExpAmt','txtFitFeeExcRate');"
                                        onkeypress="javascript:IsNumericOrDot(this, 'Please enter only numbers.');" />
                                    $
                                </td>
                                <td align="center" class="P0">
            ...
            <table cellspacing="0" class="TbCel-Type2-A">
                <colgroup>
                    ...
                    <tbody>
                        <tr>
                            <th>
                                <asp:Literal ID="Literal5" runat="server" Text="Remark"></asp:Literal>
                            </th>
                            <td>
