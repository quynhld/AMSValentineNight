<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Template/MainFrame.Master" AutoEventWireup="true" CodeBehind="TowerSalesList.aspx.cs" Inherits="KN.Web.Resident.Contract.TowerSalesList" ValidateRequest="false"%>
...
function fnContractList()
{
    ...
    var strConcYn = document.getElementById("<%=ddlConclusion.ClientID%>").value;
    
    window.open("/Common/RdPopup/RDPopupRentContractList.aspx?Datum0=" + strRentCd + "&Datum1=" + strSearchTy + "&Datum2=" + strKeyWord + "&Datum3=" + strConcYn, "ContractList", "status=no, resizable=no, width=1000, height=700, left=100,top=100, scrollbars=no, menubar=no, toolbar=no, location=no");
    return false;
}
...
<fieldset class="sh-field3 ">
	...
	<ul class="sf3-ag MrgL180">
		...
		<li><asp:DropDownList ID="ddlConclusion" runat="server" OnKeyPress="javascript:return fnCheckType();"></asp:DropDownList></li>
		<li>
    ...
    <asp:ListView ID="lvRentList" runat="server" ItemPlaceholderID="iphItemlPlaceholderId" 
        ...
        <ItemTemplate>
            <tr style="background-color:#FFFFFF;cursor:pointer;" onmouseover="this.style.backgroundColor='#E4EEF5'" onmouseout="this.style.backgroundColor='#FFFFFF'" onclick='javascript:fnDetailView("<%=Master.PAGE_VIEW%>","<%=Master.PARAM_DATA1%>","<%=Master.PARAM_DATA2%>","<%#Eval("RentCd")%>","<%#Eval("RentSeq")%>");'>
                ...
                <td class="Bd-Lt TbTxtLeft"><asp:Literal ID="ltInsTenant" runat="server"></asp:Literal></td>
                <td class="Bd-Lt TbTxtCenter"><asp:Literal ID="ltInsContPeriod" runat="server"></asp:Literal></td>
                <td class="Bd-Lt TbTxtCenter"><asp:Literal ID="ltContStep" runat="server"></asp:Literal></td>
	            ...
	            <div class="Btn-Tp3-R">
		            <div class="Btn-Tp3-M">
			            <span><asp:LinkButton ID="lnkbtnReport" runat="server" 
                            OnClientClick="javascript:return fnContractList();" 
