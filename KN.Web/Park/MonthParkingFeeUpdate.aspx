<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Template/MainFrame.Master"
    AutoEventWireup="true" CodeBehind="MonthParkingFeeUpdate.aspx.cs" Inherits="KN.Web.Park.MonthParkingFeeUpdate"
...
//-->
                ...
                <tr>
                    <th>
                        <asp:CheckBox ID="chkAll" runat="server" AutoPostBack="true" 
                            nCheckedChanged="chkAll_CheckedChanged" 
                            oncheckedchanged="chkAll_CheckedChanged" Style="text-align: left" />
                    </th>
    ...
    <div style="overflow-y: scroll; overflow-x: hidden; height: 138px; width: 840px;">     
                <asp:ListView ID="lvActMonthParkingFeeList" runat="server" ItemPlaceholderID="iphItemPlaceHolderID"
                    ...
                    onitemupdating="lvActMonthParkingFeeList_ItemUpdating">
                    <LayoutTemplate>
                        <table class="TypeA">
                            <col width="20" />
                            <col width="60" />
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td class="TbTxtCenter">                                
                                <asp:TextBox ID="txtFee" runat="server" Width="90"></asp:TextBox>
                            </td>
                            <td class="TbTxtCenter">
