<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Template/MainFrame.Master" AutoEventWireup="true" CodeBehind="ParkingContractList.aspx.cs" Inherits="KN.Web.Park.ParkingContractList" ValidateRequest="false"%>
...
<table class="TypeA" width="840px">
    ...
    <thead>
        <tr>
            <th class="TbTxtCenter" ><asp:Literal ID="ltTopSeq" runat="server"></asp:Literal></th>
            <th class="TbTxtCenter"><asp:Literal ID="ltTopRoomNo" runat="server"></asp:Literal></th>
            <th class="TbTxtCenter"><asp:Literal ID="ltTenantName" runat="server" Text="Tenant Name"></asp:Literal></th>
            <th class="TbTxtCenter"><asp:Literal ID="ltTopTaxCode" runat="server" Text="Tax Code"></asp:Literal></th>
            <th class="TbTxtCenter"><asp:Literal ID="ltTopAddress" runat="server" Text="Address"></asp:Literal></th>
            <th class="TbTxtCenter"><asp:Literal ID="Literal1" runat="server" Text="Type"></asp:Literal></th>
        </tr>
    </thead>
</table>
<div style="overflow-y:scroll;overflow-x:hidden;height:420px;width:840px;">
        ...
        <asp:ListView ID="lvActMonthParkingCardList" runat="server" ItemPlaceholderID="iphItemPlaceHolderID"
            ...
            <ItemTemplate>
                <tr style="background-color:#FFFFFF;cursor:pointer;" onmouseover="this.style.backgroundColor='#E4EEF5'" onmouseout="this.style.backgroundColor='#FFFFFF'" onclick="javascript:return fnDetailView('<%#Eval("UserSeq")%>')">
                    ...
                    <td class="TbTxtCenter">
                        <asp:Literal ID="ltTenantName" runat="server"></asp:Literal>
                    </td>
		            <td class="TbTxtCenter">		              
                    ...
                    <td class="TbTxtCenter">
                        <asp:Literal ID="ltLessor" runat="server"></asp:Literal>
                    </td>
                </tr>
            </ItemTemplate>
            <EmptyDataTemplate>
    ...
    <div class="Btn-Type3-wp ">
        <div class="Btn-Tp3-L">
            <div class="Btn-Tp3-R">
                <div class="Btn-Tp3-M">
                    <span>
                        <asp:LinkButton ID="lnkbtnWrite" runat="server" Text="Create New Tenant" 
