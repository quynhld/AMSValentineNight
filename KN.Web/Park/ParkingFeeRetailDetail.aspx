<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Template/MainFrame.Master"
    AutoEventWireup="true" CodeBehind="ParkingFeeRetailDetail.aspx.cs" Inherits="KN.Web.Park.ParkingFeeRetailDetail"
...
<asp:Content ID="ctCont" ContentPlaceHolderID="cphContent" runat="server">
    ...
    function fnOpenCalendar(obj)
    {
     ...
     function fnCardNoChange()
     {
        var strCarTy = document.getElementById("<%=ddlInputCarTy.ClientID%>");
        var strCardNo = document.getElementById("<%=txtInputParkingCardNo.ClientID%>");

        if (trim(ddlInputCarTy.value) != "0000" && trim(txtInputParkingCardNo.value) != "")
        {
            document.getElementById("<%=imgbtnInputCardNoChange.ClientID%>").click();
     ...
     function fnChangePopup(strCompNmId, strRoomNoId,strUserSeqId,strCompNmS,strRentCd)
    {
        ...
        window.open("/Common/Popup/PopupCompFindList.aspx?CompID=" + strCompNmId + "&RoomID=" + strRoomNoId+ "&UserSeqId=" + strUserSeqId+ "&CompNmS=" + strCompNmS+"&RentCdS=" +strRentCd , 'SearchTitle', 'status=no, resizable=no, width=800, height=655, left=200,top=200, scrollbars=no, menubar=no, toolbar=no, location=no');
    ...
    function LoadCalender() {
        ...
        datePicker();  
         ...
         $('#<%=txtInputCarNo.ClientID %>').keydown(function(e) {          
    ...
    function datePicker() {
        ...
        $("#<%=txtSearchPayDt.ClientID %>").datepicker();     
...
//-->
    ...
    <fieldset class="sh-field5 MrgB10">
        ...
        <ul class="sf5-ag MrgL30">
            ...
            <li>
                <asp:Literal ID="ltComPanyName" runat="server"></asp:Literal></li>
            <li><b>
                <asp:Literal ID="Literal1" runat="server" Text="Room :"></asp:Literal></b></li>
            <li>
                <asp:Literal ID="ltRoomNo" runat="server"></asp:Literal></li>
        </ul>
        <ul class="sf5-ag MrgL30 bgimgN">
            ...
            <li><b>
                <asp:Literal ID="ltTerm" runat="server" Text="Payment Date :"></asp:Literal>
            </li>
            <li>
                <asp:TextBox ID="txtSearchPayDt" CssClass="grBg bgType2" MaxLength="10" Width="70px"
                    runat="server" Visible="True"></asp:TextBox>
                <img align="absmiddle" alt="Calendar" onclick="CallCalendar('#<%=txtSearchPayDt.ClientID%>')"
    ...
    <asp:UpdatePanel ID="upSearch" runat="server" UpdateMode="Conditional">
        <Triggers>
            ...
            <asp:AsyncPostBackTrigger ControlID="imgbtnInputCardNoChange" EventName="Click" />
            <asp:AsyncPostBackTrigger ControlID="lnkbtnNew" EventName="Click" /> 
        ...
        <ContentTemplate>
            ...
            <div style="overflow-y: scroll; overflow-x: hidden; height: 160px; width: 840px;">
    ...
    <asp:UpdatePanel ID="upRegist" runat="server" UpdateMode="Conditional">
        <Triggers>
            ...
            <asp:AsyncPostBackTrigger ControlID="ddlInputCarTy" EventName="SelectedIndexChanged" />
            <asp:AsyncPostBackTrigger ControlID="ddlCarNo" EventName="SelectedIndexChanged" />            
        ...
        <ContentTemplate>
            <table cellspacing="0" class="TbCel-Type1 iw840">
                <tr>
                    ...
                    <td>
                        ...
                        <asp:TextBox ID="txtHfRentCd" runat="server" Visible="false"></asp:TextBox>
                        <asp:TextBox ID="hfRealBaseRate" runat="server" Visible="false"></asp:TextBox>
                       <asp:Literal ID="ltRealBaseRate" runat="server" Visible ="false"></asp:Literal>
                    </td>
                    <th align="center">
                    ...
                    <td>
                        ...
                        <asp:TextBox ID="txtInputCarNo" runat="server" CssClass="bgType2" MaxLength="20" Width="100" Visible = "false"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:DropDownList ID="ddlInputCarTy" runat="server" 
                             Visible = "false" 
                            onselectedindexchanged="ddlInputCarTy_SelectedIndexChanged" AutoPostBack = "true"></asp:DropDownList>
                    </td>
                    <th align="center">
                    ...
                    <td colspan="3">
                        ...
                        <asp:TextBox ID="txtInputParkingCardNo" runat="server" CssClass="bgType2"  
                            MaxLength="10" Width="100" Visible = "false" AutoPostBack = "true" 
                            ontextchanged="txtInputParkingCardNo_TextChanged"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <th align="center">
             ...
             <asp:HiddenField ID="hfIsCreateYN" runat="server"/>
            ...
            <asp:ImageButton ID="imgbtnInputCardNoChange" runat="server" ImageUrl="~/Common/Images/Common/blank.gif"
            OnClick="imgbtnInputCardNoChange_Click" />
        ...
        <div class="Btn-Type3-wp ">
            <div class="Btn-Tp3-L">
                <div class="Btn-Tp3-R">
                    <div class="Btn-Tp3-M">
                        <span>
                            <asp:LinkButton ID="lnkbtnNew" runat="server" Text = "Create New" 
                            onclick="lnkbtnNew_Click"></asp:LinkButton></span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="Btn-Type3-wp ">
            <div class="Btn-Tp3-L">
                <div class="Btn-Tp3-R">
                    <div class="Btn-Tp3-M">
                        <span>
                            <asp:LinkButton ID="lnkbtnPrint" runat="server" OnClick="lnkbtnPrint_Click1">Print Receipt</asp:LinkButton></span>
                    </div>
                </div>
            </div>
        </div>
        <div class="Btn-Type3-wp ">
            <div class="Btn-Tp3-L">
                <div class="Btn-Tp3-R">
                    <div class="Btn-Tp3-M">
                        <span>
                            <asp:LinkButton ID="lnkbtnCancel" runat="server" Text = "Cancel" onclick="lnkbtnCancel_Click" 
                            ></asp:LinkButton></span>
                    </div>
                </div>
            </div>
