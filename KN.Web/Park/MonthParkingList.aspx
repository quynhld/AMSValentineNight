<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Template/MainFrame.Master" AutoEventWireup="true" CodeBehind="MonthParkingList.aspx.cs" Inherits="KN.Web.Park.MonthParkingList" ValidateRequest="false"%>
...
{
    var strData1 = document.getElementById("<%=hfStartDt.ClientID%>").value;
    var strData2 = document.getElementById("<%=hfEndDt.ClientID%>").value;
...
<fieldset class="sh-field2 MrgB10">
    ...
    <ul class="sf2-ag MrgL30">       
        ...
        <li>      
		    ...
		    <img align="absmiddle" alt="Calendar" onclick="CallCalendar('#<%=txtEndDt.ClientID %>')" src="/Common/Images/Common/calendar.gif" style="cursor: pointer;align: absmiddle;"  />
		    <asp:HiddenField ID="hfEndDt" runat="server"/>
        </li>                
        <li><asp:TextBox ID="txtCarNo" runat="server" Width="60px" MaxLength="20" CssClass="sh-input" Visible="false"></asp:TextBox></li>
        <li><asp:Literal ID="ltInsCardNo" runat="server"></asp:Literal></li>
        <li><asp:TextBox ID="txtInsCardNo" runat="server" Width="60px" MaxLength="20" CssClass="sh-input" ></asp:TextBox></li>
        <li><asp:Literal ID="ltInsCarNo" runat="server"></asp:Literal></li>
        <li><asp:TextBox ID="txtInsCarNo" runat="server" Width="60px" MaxLength="20" CssClass="sh-input" ></asp:TextBox></li>
        <li>
...
<asp:ListView ID="lvActDayParkingFeeList" runat="server" ItemPlaceholderID="iphItemPlaceHolderID" OnItemCreated="lvActDayParkingFeeList_ItemCreated" 
    ...
    <LayoutTemplate>
        <table class="TypeA" id="tblListDebit">
            ...
            <thead>
                <tr>
                    <th class="Fr-line"><asp:Literal ID="ltCarNo" runat="server"></asp:Literal></th>
...
<div class="Btwps FloatR">
    <div class="Btn-Type3-wp FloatL">
	    <div class="Btn-Tp3-L">
		    <div class="Btn-Tp3-R">
			    <div class="Btn-Tp3-M">
				    <span><asp:LinkButton ID="lnkbtnReport" runat="server" OnClientClick="javascript:return fnMonthlyParkingList();"></asp:LinkButton></span>
			    </div>
		    </div>
	    </div>
    </div>
