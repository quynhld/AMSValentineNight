...
{
    public partial class OfficeParkingMonthlyReport : BasePage
    {
        ...
        protected void InitControls()
        {
            ...
            lnkbtnPrint.OnClientClick = "javascript:return fnCheckMonth('" + AlertNm["ALERT_INSERT_BLANK"] + "');";
        ...
        protected void lnkbtnPrint_Click(object sender, EventArgs e)
        {
            ...
            {                
                ...
                period = txtSearchDt.Text.Replace("-", "");
                tenant = txtTenanNm.Text;

                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "PreviewPrint", "fnAccountList('" + room + "','" + tenant + "','" + period + "');", CommValue.AUTH_VALUE_TRUE);
