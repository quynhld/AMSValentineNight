<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Template/MainFrame.Master" AutoEventWireup="true" CodeBehind="ExchangeModify.aspx.cs" Inherits="KN.Web.Config.Exchange.ExchangeModify" ValidateRequest="false"%>
...
<!--//
    ...
    function fnCheckValidate(strtext, strAlert)
    {
        if (confirm(strtext))
        {
            ...
            var strFluctAmt = document.getElementById("<%= txtFluctAmt.ClientID %>");
            var strFluctRatio = document.getElementById("<%= txtFluctRatio.ClientID %>");
...
<asp:UpdatePanel ID="upExchange" runat="server" UpdateMode="Conditional">
    ...
    <ContentTemplate>
        <div class="Tb-Tp-tit"><asp:Literal ID="ltRealRate" runat="server"></asp:Literal></div>
        <table class="TbCel-Type6-A">
            <tr>                
                <th><asp:Literal ID="ltTopDate" runat="server"></asp:Literal></th>
                <th class="Bd-Lt Tb"><asp:Literal ID="ltTopBaseRate" runat="server"></asp:Literal></th>
                <th class="Bd-Lt Tb"><asp:Literal ID="ltTopBuying" runat="server"></asp:Literal></th>
                <th class="Bd-Lt Tb"><asp:Literal ID="ltTopSelling" runat="server"></asp:Literal></th>
            </tr>
            <tr>
                <td class="TbTxtCenter"><asp:Literal ID="ltRealDate" runat="server"></asp:Literal></td>
                <td class="Bd-Lt Tb TbTxtCenter"><asp:Literal ID="ltRealBaseRate" runat="server"></asp:Literal></td>
                <td class="Bd-Lt Tb TbTxtCenter"><asp:Literal ID="ltRealBuying" runat="server"></asp:Literal></td>
                <td class="Bd-Lt Tb TbTxtCenter"><asp:Literal ID="ltRealSelling" runat="server"></asp:Literal></td>
            </tr>
        </table>
        <div class="Tb-Tp-tit"><asp:Literal ID="ltAppliedRate" runat="server"></asp:Literal></div>
        <table cellpadding="0" class="TbCel-Type3-D Clear">
            <tr>                
                <th rowspan="2"><asp:Literal ID="ltDate" runat="server"></asp:Literal></th>
                <th class="Bd-Lt" rowspan="2"><asp:Literal ID="ltBaseRate" runat="server"></asp:Literal></th>
                <th class="Bd-Lt" rowspan="2"><asp:Literal ID="ltFluctAmt" runat="server"></asp:Literal></th>
                <th class="Bd-Lt" rowspan="2"><asp:Literal ID="ltFluctRatio" runat="server"></asp:Literal></th>
                <th class="Bd-Lt" colspan="2"><asp:Literal ID="ltCash" runat="server"></asp:Literal></th>
                <th class="Bd-Lt" colspan="2"><asp:Literal ID="ltWireTrans" runat="server"></asp:Literal></th>
            </tr>
            <tr>
            ...
            <tr>
                <td class="Bd-Lt TbTxtCenter">
                    <asp:TextBox ID="txtDate" runat="server" CssClass="bgType2" Width="80px" MaxLength="8" ReadOnly="true"></asp:TextBox>
                    <asp:HiddenField ID="hfDate" runat="server"/>
                </td>
                <td class="Bd-Lt TbTxtCenter"><asp:TextBox ID="txtBaseRate" runat="server" CssClass="bgType2" Width="60px" OnTextChanged="txtBaseRate_TextChanged" AutoPostBack="true"></asp:TextBox></td>
                <td class="Bd-Lt TbTxtCenter"><asp:TextBox ID="txtFluctAmt" runat="server" CssClass="bgType2" Width="50px" ReadOnly="true"></asp:TextBox></td>
                <td class="Bd-Lt TbTxtCenter"><asp:TextBox ID="txtFluctRatio" runat="server" CssClass="bgType2" Width="50px" ReadOnly="true"></asp:TextBox>%</td>
                <td class="Bd-Lt TbTxtCenter"><asp:TextBox ID="txtBuying" runat="server" CssClass="bgType2" Width="60px"></asp:TextBox></td>
                <td class="Bd-Lt TbTxtCenter"><asp:TextBox ID="txtSelling" runat="server" CssClass="bgType2" Width="60px"></asp:TextBox></td>
                <td class="Bd-Lt TbTxtCenter"><asp:TextBox ID="txtSending" runat="server" CssClass="bgType2" Width="60px"></asp:TextBox></td>
                <td class="Bd-Lt TbTxtCenter"><asp:TextBox ID="txtReceiving" runat="server" CssClass="bgType2" Width="60px"></asp:TextBox></td>
            </tr>
        </table>
	    <div class="Btwps FloatR">
		    <div class="Btn-Type3-wp ">
			    <div class="Btn-Tp3-L">
				    <div class="Btn-Tp3-R">
					    <div class="Btn-Tp3-M">
						    <span> <asp:LinkButton ID="lnkbtnSave" runat="server" OnClick="lnkbtnSave_Click"></asp:LinkButton></span>
					    </div>
				    </div>
			    </div>
		    </div>
