...
{
    public partial class MemberMngModify : BasePage
    {
        ...
        private void LoadData()
        {
            ...
            if (dtReturn != null)
            {
                if (dtReturn.Rows.Count > 0)
                {
                    ...
                    {
                        txtEnterDt.Text = TextLib.MakeDateEightDigit(dtReturn.Rows[0]["EnterDt"].ToString());
                        hfOrgEnterDt.Value = TextLib.MakeDateEightDigit(dtReturn.Rows[0]["EnterDt"].ToString());
                        hfEnterDt.Value = dtReturn.Rows[0]["EnterDt"].ToString();
                    }

                    if (!string.IsNullOrEmpty(dtReturn.Rows[0]["RetireDt"].ToString()))
                    {
                        txtRetireDt.Text = TextLib.MakeDateEightDigit(dtReturn.Rows[0]["RetireDt"].ToString());
                        hfOrgRetireDt.Value = TextLib.MakeDateEightDigit(dtReturn.Rows[0]["RetireDt"].ToString());
        ...
        private void ResetControls()
        {
            ...
            ddlFMSAuthYn.SelectedValue = txtHfFMSAuthYn.Text;
            txtEnterDt.Text = hfOrgEnterDt.Value;
            hfEnterDt.Value = hfOrgEnterDt.Value;
            txtRetireDt.Text = hfOrgRetireDt.Value;
            hfRetireDt.Value = hfOrgRetireDt.Value;
