<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Template/MainFrame.Master" AutoEventWireup="true" CodeBehind="MemberMngModify.aspx.cs" Inherits="KN.Web.Config.Authority.MemberMngModify" ValidateRequest="false"%>
...
<table cellspacing="0" class="TbCel-Type2-A">
    ...
    <tr>
        ...
        <td>
            ...
            <asp:HiddenField ID="hfOrgEnterDt" runat="server" />
        </td>
        <th class="lebd"><asp:Literal ID="ltRetireDt" runat="server"></asp:Literal></th>
        <td>
            <asp:TextBox ID="txtRetireDt" runat="server" ReadOnly="true" Width="70" MaxLength="10"></asp:TextBox>
            <a href="#"><img align="absmiddle" alt="Calendar" onclick="Calendar(this, '<%=txtRetireDt.ClientID%>', '<%=hfRetireDt.ClientID%>', true)" src="/Common/Images/Common/calendar.gif" style="cursor:pointer;" value=""/></a>
            <asp:HiddenField ID="hfRetireDt" runat="server" />
            <asp:HiddenField ID="hfOrgRetireDt" runat="server" />
        </td>
    </tr>
    <tr>
