<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Template/MainFrame.Master" AutoEventWireup="true" CodeBehind="ReplyMemoWrite.aspx.cs" Inherits="KN.Web.Board.Memo.ReplyMemoWrite" ValidateRequest="false"%>
...
<table cellspacing="0" class="TbCel-Type1">
    ...
    <tbody>
        <tr>
            ...
            <td><asp:TextBox ID="txtTitle" runat="server" Width="450px" MaxLength="255" Text=" [Re] "></asp:TextBox></td>
        </tr>
        <tr>
            <th valign="top"><asp:Literal ID="ltContent" runat="server"></asp:Literal></th>
            <td><asp:TextBox runat="server" ID="txtContext" Rows="10" Columns="60" TextMode="MultiLine"></asp:TextBox></td>
        </tr>
        <tr>
