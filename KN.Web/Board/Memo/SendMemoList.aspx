<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Template/MainFrame.Master" AutoEventWireup="true" CodeBehind="SendMemoList.aspx.cs" Inherits="KN.Web.Board.Memo.SendMemoList" ValidateRequest="false"%>
...
<asp:UpdatePanel ID="upLogList" runat="server" UpdateMode="Conditional">
    ...
    <ContentTemplate>
        <asp:ListView ID="lvMemoList" runat="server" ItemPlaceholderID="iphItemlPlaceholderId"
                ...
                <table cellspacing="0" class="TypeA">
                    ...
                    <thead>
                        <tr>
	                        ...
	                        <th><asp:Literal ID="ltReceiver" runat="server"></asp:Literal></th>
	                        <th><asp:Literal ID="ltTitle" runat="server"></asp:Literal></th>
	                        <th><asp:Literal ID="ltSendDate" runat="server"></asp:Literal></th>
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td>
                        <asp:Literal ID="ltInsReceiver" runat="server"></asp:Literal>
                        <asp:TextBox ID="txtHfReceiver" runat="server" Visible="false"></asp:TextBox>
                        <asp:TextBox ID="txtHfReceiverCompNo" runat="server" Visible="false"></asp:TextBox>
                    </td>
                    <td><asp:Literal ID="ltInsTitle" runat="server"></asp:Literal></td>
                    <td align="center"><asp:Literal ID="ltInsSendDate" runat="server"></asp:Literal></td>
        ...
        <asp:HiddenField ID="hfMemoSeq" runat="server"/>
        <asp:HiddenField ID="hfReceiveMemNo" runat="server"/>
        </ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>