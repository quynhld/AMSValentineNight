<%@ Page Language="C#" MasterPageFile="~/Common/Template/MainFrame.Master" AutoEventWireup="true" CodeBehind="CompModify.aspx.cs" Inherits="KN.Web.Stock.Company.CompModify" ValidateRequest="false"%>
	    ...
	    <tbody>
            ...
            <tr>
                ...
                <td colspan="3">
                    ...
                    <asp:Label ID="lblFileNm1" runat="server"></asp:Label>
            ...
            <tr>
                ...
                <td colspan="3">
                    ...
                    <asp:Label ID="lblFileNm2" runat="server"></asp:Label>
            ...
            <tr>
                ...
                <td colspan="3">
                    ...
                    <asp:Label ID="lblFileNm3" runat="server"></asp:Label>
