<%@ Page Language="C#" MasterPageFile="~/Common/Template/MainFrame.Master" AutoEventWireup="true" CodeBehind="ReleaseRequestWrite.aspx.cs" Inherits="KN.Web.Stock.Release.ReleaseRequestWrite" ValidateRequest="false"%>
            ...
            <asp:ListView ID="lvRequestList" runat="server" ItemPlaceholderID="iphItemPlaceHolderID" 
                ...
                <ItemTemplate>
	                <tr>
		                ...
		                <td class="Bd-Lt TbTxtCenter">
		                    <asp:TextBox ID="txtInsQty" runat="server" CssClass="iw120" MaxLength="10"></asp:TextBox>
