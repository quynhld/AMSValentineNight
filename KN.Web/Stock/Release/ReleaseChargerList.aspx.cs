...
{
    public partial class ReleaseChargerList : BasePage
    {
        int intStep = 0;
        ...
        {
            // KN_USP_STK_INSERT_TEMPCHARGERINFO_S01
            DataTable dtTmpSeqReturn = MaterialMngBlo.RegistryTempChargerFromReleaseCharger();
        ...
        protected void lnkbtnModify_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                // 기존 정보 삭제
                // KN_USP_STK_DELETE_RELEASECHARGERINFO_M00
                ...
                for (int intTmpI = 0; intTmpI < lvAssignList.Items.Count; intTmpI++)
                {
                    ...
                    if (!chkException.Checked)
                    {
                        ...
                        // KN_USP_STK_INSERT_RELEASECHARGERINFO_M00
                        MaterialMngBlo.RegistryReleaseChargerInfo(intCnt, txtHfMemNo.Text, Session["CompCd"].ToString(), Session["MemNo"].ToString(), strIP);
